    ...
    <body class="hold-transition sidebar-mini">
        <div class="wrapper">
            <?php 
                ...
                $sales_order_id = $query_result['sales_order_id'];
            ?> 
                                        ...
                                        <div class="card-body">
                                            <form role="form" name="purchase_detail_form" enctype="multipart/form-data" action="<?php echo site_url('sales/purchase_order_register/save_second_page_purchase_order');?>" method="post">
                                                ...
                                                <div class="card-body">
                                                    <center>
                                                        <div class="btn-group">
                                                            <a href="<?php echo site_url('create_purchase_order_against_sales_order/'.$sales_order_id);?>" class="btn btn-block btn-danger">
                                                            Back
                                                            </a>
                                                        </div>
