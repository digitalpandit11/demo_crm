                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Todays Task Index</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'task_index'?>">Todays Task Index</a></li>
                                        </ol>
                                    </div>      
                                </div>   
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">Todays Task Index</h3>
                                        </div>
                                        ...
                                        <div class="btn-group" style="margin-bottom: 15px; margin-left: 15px;">
                                              ...
                                              <div class="dropdown-menu">
                                                <a class="dropdown-item btn btn-block btn-primary" href="overdue_task_index">All Overdue Tasks</a>
