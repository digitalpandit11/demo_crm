        ...
        <div class="container-fluid">
          ...
          <div class="card">
            <div class="card-header">
              <h1 class="card-title">Update Next Action</h1>
              <div class="col-sm-6">
                <br><br>
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<?php echo base_url() . 'dashboard' ?>">Home</a></li>
                  <li class="breadcrumb-item"><a href="<?php echo base_url() . 'vw_tracking_data_entry' ?>">Update_next Action</a></li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Update Next Action</h3>
                </div>
                <div class="card-body">
                  <form role="form" name="enquiry_tracking_form" enctype="multipart/form-data" action="<?php echo site_url('sales/enquiry_tracking_register/close_next_action'); ?>" method="post">

                    <input type="hidden" id="offer_entity_id" name="offer_entity_id" value="<?php echo $tracking_details->offer_id ?>" required>

                    <input type="hidden" id="tracking_entity_id" name="tracking_entity_id" value="<?php echo $entity_id; ?>" required>

                    <div class="row">
                      <div class="col-sm-3">
                        <div class="form-group">
                          <label> Tracking Number </label>
                          <input type="text" name="tracking_number" id="tracking_number" class="form-control" value="<?php echo $tracking_details->tracking_number; ?>" size="50" placeholder="Enter Tracking Number" readonly>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <input type="hidden" name="customer_id" id="customer_id" class="form-control" value="<?php echo $tracking_details->customer_id;?>" readonly>

                          <input type="text" name="customer_name" id="customer_name" class="form-control" value="<?php echo $tracking_details->customer_id; ?>" size="50" placeholder="Enter Customer Name" readonly>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="date" name="tracking_date" id="tracking_date" readonly class="form-control" value="<?php echo $tracking_details->tracking_date; ?>" size="50">
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" id="tracking_descrption" name="tracking_descrption" rows="3" placeholder="Enter Tracking Description" readonly><?php echo $tracking_details->tracking_record; ?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" id="tracking_next_action" name="tracking_next_action" rows="3" placeholder="Enter Tracking Next Action" readonly><?php echo $tracking_details->next_action; ?></textarea>
                        </div>
                      </div>

                      <div class="col-sm-3">
                        <div class="form-group">
                          <label style="color: #FF0000;"> Remark * </label>
                          <textarea class="form-control" id="tracking_remark" name="tracking_remark" rows="3" placeholder="Enter Tracking Next Action" required></textarea>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <input type="date" name="action_due_date" id="action_due_date" readonly class="form-control" size="50" value = "<?php echo $tracking_details->action_due_date; ?>">
                        </div>
                      </div>
