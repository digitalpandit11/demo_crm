...
<html>
    <head>
        ...
        <title>Enquiry Tracking Register</title>
                        ...
                        <div class="container-fluid">
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Enquiry Tracking Register</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_tracking_entry'?>">Enquiry Tracking Register</a>
                                            </li>
                                        </ol>
                                    </div>      
                                </div>   
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">Enquiry Tracking Register</h3>
                                        </div>
                                        <div>
                                            <div class="btn-group" style="margin-top: 15px; margin-left: 15px;">
                                                <a href="<?php echo base_url().'vw_tracking_data_entry'?>" class="btn btn-block btn-primary">
                                                Track Lead
                                                </a>
                                            </div>
                                        </div>
