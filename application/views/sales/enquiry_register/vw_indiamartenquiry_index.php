...
<html>
    <head>
        ...
        <title>IndiaMart Enquiry Register</title>
                        ...
                        <div class="container-fluid">
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">IndiaMart Enquiry Register</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_enquiry_data'?>">IndiaMart Enquiry Register</a>
                                            </li>
                                        </ol>
                                    </div>      
                                </div>   
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">IndiaMart Enquiry Register</h3>
                                        </div>
                                        <div>
                                            <div class="btn-group" style="margin-top: 15px; margin-left: 15px;">
                                                <a href="create_customer_indiamartenquiry" class="btn btn-block btn-primary">
                                                Create IndiaMart Enquiry
                                                </a>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                                ...
                                                <table id="example1" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    <?php if($Enquiry_status == 1){ ?>
                                                                    <a href="<?php echo site_url('update_indiamart_enquiry_data/'.$entity_id);?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
