...
<html>
    <head>
        ...
        <title>Update IndiaMart Lead</title>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Update IndiaMart Lead</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_enquiry_data'?>">Lead Register</a></li>
                                            <li class="breadcrumb-item">Update IndiaMart Enquiry Details Of Id :- <?php  echo $entity_id; ?> </li>
                                        </ol>
                                    </div>      
                                </div>   
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">IndiaMart Lead Details Form</h3>
                                        </div>
                                        <div class="card-body">
                                            <form role="form" name="enquiry_form" enctype="multipart/form-data" action="<?php echo site_url('sales/enquiry_register/update_indiamart_enquiry');?>" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2bs4" style="width: 100%;" id="customer_name" disabled name="customer_name">
                                                                <option value="">No Selected</option>
                                                        ...
                                                        <div class="card card-primary">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            <label> IndiaMart Details *</label>
                                                                            <textarea class="form-control" id="india_mart_details" name="india_mart_details" rows="3" disabled></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                    ...
                    $.ajax({
                        ...
                        success : function(data){
                            $.each(data, function(i, item){
                                ...
                                $('[name="india_mart_details"]').val(data[i].india_mart_query_details); 
                            });
                        }
                    });
                }
