                        ...
                        <div class="container-fluid">
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Lead Register</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_enquiry_data'?>">Lead Register</a>
                                            </li>
                                        </ol>
                                    </div>      
                                </div>   
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div>
                                            ...
                                            <div class="btn-group" style="margin-top: 15px; margin-left: 15px;">
                                                <a href="vw_old_enquiry_data" class="btn btn-block btn-primary">
                                                Old Lead's
                                                </a>
                                            </div>
                                        </div>
