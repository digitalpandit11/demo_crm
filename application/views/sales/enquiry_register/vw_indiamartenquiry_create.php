...
<html>
    <head>
        ...
        <title>Create IndiaMart Enquiry</title>
    ...
    <body class="hold-transition sidebar-mini">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Create IndiaMart Enquiry</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_enquiry_data'?>">Enquiry Register</a></li>
                                            <li class="breadcrumb-item">Enter IndiaMart Enquiry Details</li>
                                        </ol>
                                    </div>      
                                </div>   
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <form role="form" name="enquiry_form" enctype="multipart/form-data" action="<?php echo site_url('sales/enquiry_register/save_indiamart_enquiry');?>" method="post">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="customer_name" id="customer_name" class="form-control" size="50" placeholder="Customer Name">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="enquiry_contact_person" id="enquiry_contact_person" class="form-control" size="50" placeholder="Customer Contact Person">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="enquiry_email_id" id="enquiry_email_id" class="form-control" size="50" placeholder="Customer Email Id">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="enquiry_contact_number" id="enquiry_contact_number" class="form-control" size="50" placeholder="Customer Contact Number">
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <!-- <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="enquiry_source" id="enquiry_source" class="form-control" value="Indiamart" placeholder="Enquiry Source">
                                                        </div>
                                                    </div> -->
        ...
        <script type="text/javascript">
            ...
            $(document).on('click', '#add_address', function () {
                ...
                // if(address_type != "" && address != "" && state_id != "" && city_id != "" && customer_pin_code != "" && customer_state_code != "" && contact_person != "" && contact_person_email_id != "" && first_contact_no != "" && customer_name != "" && customer_type != "")
                // {
                    $.ajax({
