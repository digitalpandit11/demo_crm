                    ...
                    success: function(data){
                      if(data[0]){
                        $.each(data, function(i, item){
                            ...
                            $('[name="enquiry_contact_person"]').val('');
                            $('[name="enquiry_contact_number"]').val('');
                            $('[name="customer_name"]').val('');

                            $('[name="customer_type"]').val('').trigger('change');
                            $('[name="address"]').val('');
                            $('[name="state_id"]').val('').trigger('change');
                            $('[name="city_id"]').val('').trigger('change');
                            $('[name="state_code"]').val('');
                            $('[name="customer_pin_code"]').val('');
                            $('[name="customer_gst_number"]').val('');
                            $('[name="customer_pan_number"]').val('');
                        }
                      }
                        });
                    ...
                    success: function(data){
                      if(data[0]){
                        ...
                        $.each(data, function(i, item){
                          ...
                          $('[name="customer_id"]').val('');
                          $('[name="enquiry_contact_person"]').val('');
                          $('[name="enquiry_email_id"]').val('');
                          $('[name="customer_name"]').val('');
                          $('[name="customer_type"]').val('');
                          $('[name="address"]').val('');
                          $('[name="state_id"]').val('');
                          $('[name="city_id"]').val('');
                          $('[name="state_code"]').val('');
