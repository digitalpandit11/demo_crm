                                ...
                                <div class="card-header" >
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_tracking_entry'?>">Offer Tracking Register</a>
                                            </li>
                                        </ol>
                                    </div>      
                                </div>   
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div>
                                            <div class="btn-group" style="margin-top: 15px; margin-left: 15px;">
                                                <a href="create_customer_offer_tracking" class="btn btn-block btn-primary">
