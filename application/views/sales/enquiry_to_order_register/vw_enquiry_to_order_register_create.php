    ...
    <body class="hold-transition sidebar-mini">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Create Enquiry</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_all_enquiry_to_order_data'?>">Enquiry Register</a></li>
                                            <li class="breadcrumb-item">Enter Enquiry Details</li>
                                        </ol>
                                    </div>      
                                </div>   
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <form role="form" name="enquiry_form" enctype="multipart/form-data" action="<?php echo site_url('sales/enquiry_to_order_register/save_enquiry');?>" method="post">
                                                        ...
                                                        <div class="form-group">   
                                                            ...
                                                            <div class="input-group">
                                                                <div class="custom-file">
                                                                    <input type="file" class="custom-file-input" name="employee_attachment[]"  id="employee_attachment">
                                                ...
                                                <div class="card-body">
                                                    <center>
                                                        <div class="btn-group">
                                                            <a href="vw_all_enquiry_to_order_data" class="btn btn-block btn-danger">
                                                            Back
                                                            </a>
                                                        </div>
        ...
        <script>
            $(document).on('click', '#confirm_offer', function () {
                ...
                if(customer_name != "" && employee_id != "" && enquiry_descrption != "" && enquiry_type != "" && enquiry_source != "" && enquiry_urgency != "")
                {
                    $.ajax({
                        url:"<?php echo site_url('sales/enquiry_to_order_register/save_enquiry_to_offer');?>",
                        type: 'POST',
                        data: {'customer_name': customer_name  , 'employee_id': employee_id , 'enquiry_descrption': enquiry_descrption , 'enquiry_type': enquiry_type , 'enquiry_source': enquiry_source , 'enquiry_urgency': enquiry_urgency},
                        success: function(data){
                            data = data.trim();
                            /*console.log(data);*/
                            window.location.href = "set_enquiry_to_offer/" + data;
                        },
                        error: function(){
                            alert("Fail");
                        }
