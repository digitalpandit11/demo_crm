...
<html>
    <head>
        ...
        <title>Create Offer From Enquiry</title>
    ...
    <body class="hold-transition sidebar-mini">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Create Offer From Enquiry</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">Enter Offer Details</li>
                                        </ol>
                                    </div>      
                                </div>   
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <form role="form" name="offer_form" id="offer_form" enctype="multipart/form-data" action="<?php echo site_url('sales/enquiry_to_order_register/save_offer');?>" method="post">
                                                ...
                                                <div class="card-body">
                                                    <center>
                                                        ...
                                                        <?php if($offer_product_relation_count_data > 0) {?>
                    ...
                    $.ajax({
                        ...
                        success : function(data){
                            $.each(data, function(i, item){
                                ...
                                $('[name="winning_chance"]').val(data[i].winning_chance);
                            });
                        }
                    });
                }
        ...
        <script type="text/javascript">
            ...
            function show_table_details(){
                /*document.getElementById('boq_applicable').style.display = "display";
                $('#boq_not_applicable').hide(); */ 
                $('#boq_not_applicable').hide(); 
                $('#boq_applicable').show(); 
            }
        </script>
