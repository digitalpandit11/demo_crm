...
<html>
    <head>
        ...
        <title>Update IndiaMart Enquiry</title>
    ...
    <body class="hold-transition sidebar-mini">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Update IndiaMart Enquiry</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">Update Details Of Id :- <?php  echo $entity_id; ?> </li>
                                        </ol>
                                    </div>      
                                </div>   
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">IndiaMart Enquiry Details Form</h3>
                                        </div>
                                        <div class="card-body">
                                            <form role="form" name="enquiry_form" enctype="multipart/form-data" action="<?php echo site_url('sales/enquiry_to_order_register/update_indiamart_enquiry');?>" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <!-- <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="customer_name" id="customer_name" class="form-control" size="50" placeholder="Enter Enquiry Number" readonly>
                                                        </div>
                                                    </div> -->
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3" style="display: none;">
                                                        <div class="form-group">
                                                            <label style="color: #FF0000;"> Enquiry Urgency <span >*</label>
                                                            ...
                                                            <div class="col-sm-3">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-radio">
                                                                        ...
                                                                        <label for="customRadio6" class="custom-control-label">Quqlify</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control" id="enquiry_tracking_descrption" name="enquiry_tracking_descrption" rows="3" placeholder="Enter Enquiry Tracking Description"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Do You Want To Confirm Created Offer? </p>
                    </div>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function get_data_edit(){
                    ...
                    $.ajax({
                        url : "<?php echo site_url('sales/enquiry_register/get_indiamart_enquiry_details_by_id');?>",
                        method : "POST",
        ...
        <script>
            $(document).on('click', '#confirm_offer', function () {
                ...
                var enquiry_source = document.getElementById('enquiry_source').value;
                var enquiry_urgency = document.getElementById('enquiry_urgency').value;

                if(entity_id != "" && customer_name != "" && employee_id != "" && enquiry_descrption != "" && enquiry_type != "" && enquiry_source != "" && enquiry_urgency != "")
                {
                    $.ajax({
                        url:"<?php echo site_url('sales/enquiry_to_order_register/update_enquiry_to_save_offer');?>",
                        type: 'POST',
                        data: {'entity_id': entity_id , 'customer_name': customer_name , 'employee_id': employee_id , 'enquiry_descrption': enquiry_descrption , 'enquiry_type': enquiry_type , 'enquiry_source': enquiry_source , 'enquiry_urgency': enquiry_urgency},
                        success: function(data){
                            data = data.trim();
