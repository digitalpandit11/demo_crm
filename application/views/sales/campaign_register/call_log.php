    ...
    <body class="hold-transition sidebar-mini">
        ...
        <!-- Navbar -->
            <?php $this->load->view('header_sidebar');
                ...
                $this->db->select('campaign_relation.*');
                $this->db->from('campaign_relation');
                $where = '(campaign_relation.entity_id > "'.$entity_id.'" AND campaign_relation.campaign_id ="'.$campaign_id.'")';
                $this->db->where($where);
                $this->db->limit(1);
                ...
                $this->db->from('campaign_relation');
                $where = '(campaign_relation.entity_id < "'.$entity_id.'" AND campaign_relation.campaign_id ="'.$campaign_id.'")';
                $this->db->order_by('campaign_relation.entity_id', 'DESC');
                $this->db->where($where);
                $this->db->limit(1);
                            ...
                            <div class="card-header" >
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?php echo base_url().'view_campaign_clist_list/'.$campaign_id;?>">Campaign Register</a>
                                        </li>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header">
                                        ...
                                        <a href="<?php echo base_url();?>view_call_log/<?php echo $next_id;?>" class="btn btn-md btn-warning " <?php echo $ent;?> style="float:right;">Skip <i class="fas fa-arrow-right"></i></a>&nbsp;&nbsp;
                                        <a href="<?php echo base_url();?>view_call_log/<?php echo $prev_id;?>" class="btn btn-md btn-default text-black" <?php echo $pv;?> style="float:right;color:black;margin-right: 20px;"><i class="fas fa-arrow-left"></i> Previous </a>
                                    </div>
                                        ...
                                        <form method="post" action="<?php echo base_url();?>sales/campaign_register/save_call_log">
                                            ...
                                            <div class="row col-md-12">
                                                ...
                                                <div class="col-md-6 pt-5">
                                                    <div class="row">
                                                        <div class="form-group">
                                                            <input type="radio" name="open_close" required id="open_close" style="padding: 20px;" value="1">&nbsp;&nbsp;<label>Case Closed</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
