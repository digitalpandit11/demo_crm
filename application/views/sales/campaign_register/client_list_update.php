                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="row col-md-12 ">
                                          <input type="hidden" id = "campaign_id" value = "<?php echo $relation_id; ?>" >
                                        ...
                                        <div class="btn-group" style="margin-top: 15px; margin-left: 20px;">
                                            <a data-toggle="modal" data-target="#modal_add_client" class="btn btn-block btn-success" style="background-color: #5cb85c; border-color: #4cae4c; color: #ffff;">
                                                Add More Client
                                            </a>
                                        </div>
                                        </div>
                                                    ...
                                                    <tbody id = "campaign_client_list">
                                                        <?php
                                                            ...
                                                            foreach ($campaign_clients as $value):
                                                                ...
                                                                $this->db->from('telephone_master');
                                                                $this->db->join('call_log','call_log.telephone_id = telephone_master.entity_id', 'LEFT OUTER');
...
/*
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    <a href="<?php echo site_url('view_call_log/'.$value->entity_id);?>" class="btn btn-sm btn-danger item_remove" data = "<?php echo $value->entity_id; ?>" data-toggle="modal" data-target="#modal_remove_client" ><i class="fas fa-trash" aria-hidden="true"></i></a>   &nbsp;&nbsp;
                                                                </div> 
                                                            </td>
                                                        </tr>
                                                    <?php endforeach;?>
...
<!-- add client modal -->
                ...
                <div class="modal-content">
                    <div class="modal-header">
                       ...
                       <div class="modal-body">
                            <div  class="table-responsive">
                                <table id="client_details_table" class="table table-bordered table-striped">
                                    <thead>
                                       <tr>
                                          <th></th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr id="d1">
                                            <td><input type="checkbox" class="checkboxes" id="client_checkbox" name="client_checkbox" value="<?php echo $row->entity_id ?>"></td>
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="button" class="btn btn-primary" id="client_checkbox_submited">Save</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
        ...
        <div class="modal fade" id="modal_remove_client">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Deelete Client</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                       <div class="modal-body">
                            <div  class="table-responsive">
                                <p> Are your sure you want to remove this client from the list?</p>
                            </div>
                        </div>
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-primary" id="client_remove">Remove</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
        ...
        <script>
          ...
          $(document).ready(function(){
            ...
            $("#client_checkbox_submited").on('click', function(event)
                {
                    $("#client_checkbox_submited").attr("disabled", true);
                    ...
                    // var client_checkbox = [];
                    // $.each($("input[name='client_checkbox']:checked"), function(){            
                    //     client_checkbox.push($(this).val());
                    // });

                    var table = $('#client_details_table').DataTable();
                    var client_checkbox = table.$("input[name='client_checkbox']:checked").serializeArray();
                    // var client_checkbox = serializeArray(client_checkbox);

                    // console.log(client_checkbox);
                    

                    $.ajax({
                        url:"<?php echo site_url('sales/campaign_register/update_campaign_client');?>",
                        type: 'POST',
                        data: {
                          'campaign_id': campaign_id, 
                          'client_checkbox': client_checkbox
                        },
                ...
                $('#campaign_client_list').on('click', '.item_remove', function(){

                  var campaign_relation_id = $(this).attr('data');

                  // alert(campaign_relation_id);

                  
  
                          $("#client_remove").off().click(function(){
  
                            $.ajax({
                              type: 'ajax',
                              method: 'get',
                              async: false,
                              url: '<?php echo base_url() ?>sales/campaign_register/remove_campaign_client',
                              data: {
                                campaign_relation_id : campaign_relation_id
                              },
                              dataType: 'json',
