    ...
    <body class="hold-transition sidebar-mini">
        ...
        <!-- Navbar -->
            <?php $this->load->view('header_sidebar');
                ...
                $client_data = $this->db->select('*')->from('telephone_master')->where('entity_id',$telephone_id)->get()->row_array();
                ...
                $last_call= $this->db->select('last_log_date')->from('call_log')->where('campaign_relation_id',$entity_id)->order_by('entity_id','DESC')->limit(1)->get()->row_array();
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            ...
                                            <a href="<?php echo base_url();?>next_client/<?php echo $entity_id;?>" class="btn btn-md btn-warning " <?php echo $ent;?> style="float:right;">Skip <i class="fas fa-arrow-right"></i></a>&nbsp;&nbsp;
                                            <a href="<?php echo base_url();?>prev_client/<?php echo $entity_id;?>" class="btn btn-md btn-default text-black" <?php echo $pv;?> style="float:right;color:black;margin-right: 20px;"><i class="fas fa-arrow-left"></i> Previous </a>
                                        </div>
                                        <div class="row col-md-12 pt-4 ">
                                            <div class="col-md-3 border-2">
                                                <span class="text-success p-3 font-weight-bold">Client Name: - </span><label><?php echo $client_data['client_name'];?></label>
                                            </div>
                                            <div class="col-md-3">
                                                
                                                <span class="text-success p-3 font-weight-bold">Email Id : - </span><label> <?php echo $client_data['email'];?></label>
                                            </div>
                                            <div class="col-md-3">
                                                
                                                <span class="text-success p-3 font-weight-bold">Mobile No : - </span><label> <?php echo $client_data['mobile'];?></label>
                                            </div>
                                            <div class="col-md-3">
                                                
                                                <span class="text-success p-3 font-weight-bold">Company : - </span><label>  <?php echo $company_name;?></label>
                                            </div>
                                        </div>
                                        <div class="row col-md-12 pb-4">
                                            <div class="col-md-3 border-2">
                                                <span class="text-success p-3 font-weight-bold">Category: - </span><label> <?php echo $client_data['category'];?></label>
                                            </div>
                                            <div class="col-md-3">
                                                
                                                <span class="text-success p-3 font-weight-bold">Designation  : - </span><label><?php echo $client_data['designation'];?></label>
                                            </div>
                                            <div class="col-md-3">
                                                
                                                <span class="text-success p-3 font-weight-bold">Source : - </span><label> <?php echo $client_data['source'];?></label>
                                            </div>
                                            <div class="col-md-3">
                                                
                                                <span class="text-success p-3 font-weight-bold">City : - </span><label> <?php echo $client_data['city'];?></label>
                                            </div>
                                        </div>
                                        <div class="row col-md-12 pb-4">
                                            <div class="col-md-3 border-2">
                                                <span class="text-success p-3 font-weight-bold">State: - </span><label> <?php echo $client_data['state'];?></label>
                                            </div>

                                            <div class="col-md-3 border-2">
                                                <span class="text-success p-3 font-weight-bold">Pincode: - </span><label> <?php echo $client_data['pincode'];?></label>
                                            </div>
                                            <div class="col-md-3">
                                                
                                                <span class="text-success p-3 font-weight-bold">Address : - </span><label> <?php echo $client_data['address'];?></label>
                                            </div>
                                            <div class="col-md-3">
                                                
                                                <span class="text-success p-3 font-weight-bold">Website : - </span><label> <?php echo $client_data['website'];?></label>
                                            </div>
                                        </div>
                                        <div class="row col-md-12 pb-4">
                                        ...
                                        <form method="post" action="<?php echo base_url();?>sales/campaign_register/save_call_log">

                                            <input type="hidden" name="call_log_data" id="call_log_data" value=" <?php echo $client_data['mobile'];?>">
                                            <input type="hidden" name="telephone_id" id="telephone_id" value=" <?php echo $client_data['entity_id'];?>">
                                            <input type="hidden" name="entity_id" id="entity_id" value="<?php echo $entity_id?>">
                                            <input type="hidden" name="campaign_name" id="campaign_name" value="<?php echo $campaign_id?>">
                                            <div class="row col-md-12">
                                                <div class="col-md-6 pt-5"> 
                                                    <div class="form-group">
                                                        <input type="radio" name="call_sts" id="call_sts" style="padding: 20px;" value="1">&nbsp;&nbsp;<label>Call Answered</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <input type="radio" name="call_sts" id="call_sts" value="2">&nbsp;&nbsp;<label>Call Not Answered</label>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="text-danger">Call Description </label>
                                                ...
                                                <div class="col-md-6 pt-5">
                                                    <div class="row">
                                                        <div class="form-group">
                                                            <input type="radio" name="open_close" id="open_close" style="padding: 20px;" value="1">&nbsp;&nbsp;<label>Case Closed</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <input type="radio" name="open_close" id="open_close" value="2">&nbsp;&nbsp;<label>Follow-Up Required</label>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                            ...
                                            <a href="<?php echo base_url();?>next_client/<?php echo $entity_id;?>" class="btn btn-md btn-info text-white" <?php echo $ent;?> >Create Lead</a>&nbsp;&nbsp;
                                                ...
                                                <table id="example1" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    <a href="<?php echo site_url('client_add_to_customer_master/'.$entity_id);?>" class="btn btn-sm btn-success"><i class="fas fa-envelope"></i></a> 
                                                                </div> 
                                                            </td> -->
                                                        </tr>
                                                    <?php endforeach;?>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                var relation = $('#call_log_data').val();
