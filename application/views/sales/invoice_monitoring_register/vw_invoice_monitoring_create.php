...
<html>
    <head>
        ...
        <title>Create Invoice Monitoring</title>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Create Invoice Monitoring</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_invoice_monitoring'?>">Invoice Monitoring</a></li>
                                            <li class="breadcrumb-item">Enter Invoice Monitoring Details</li>
                                        </ol>
                                    </div>      
                                </div>   
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <form role="form" name="invoice_monitoring_form" enctype="multipart/form-data" action="<?php echo site_url('sales/invoice_monitoring_register/save_invoice_monitoring');?>" method="post">
