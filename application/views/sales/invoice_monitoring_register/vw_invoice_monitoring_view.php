...
<html>
    <head>
        ...
        <title>View Invoice Monitoring </title>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">View Invoice Monitoring</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_invoice_monitoring'?>">Invoice Monitoring</a></li>
                                            <li class="breadcrumb-item">View Invoice Monitoring Details Of Id :- <?php  echo $entity_id; ?> </li>
                                        </ol>
                                    </div>      
                                </div>   
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <form role="form" name="invoice_monitoring_form" enctype="multipart/form-data" action="<?php echo site_url('sales/invoice_monitoring_register/view_invoice_monitoring');?>" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2bs4" style="width: 100%;" id="sales_order_id" name="sales_order_id" disabled>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control" id="invoice_date" name="invoice_date" disabled> 
                                                        </div>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="invoice_amount" name="invoice_amount" placeholder="Enter Invoice Amount" disabled> 
                                                        </div>
                                                    </div>
