...
<html>
    <head>
        ...
        <title>Select Sales Order</title>
                        ...
                        <div class="container-fluid">
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Select Sales Order</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_performa_invoice_data'?>">Performa Register</a>
                                            </li>
                                            <li class="breadcrumb-item">Select Sales Order</a>
                                            </li>
                                        </ol>
                                    </div>      
                                </div>   
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <a href="<?php echo site_url('create_performa_against_sales_order/'.$row->entity_id);?>" class="btn btn-sm btn-danger" onclick="return confirm('Are You Sure To Create Performa ?')"><i class="fas fa-check-circle"></i></a> 
                                                                </div> 
                                                            </td>
                                                        </tr>
                                                    <?php endforeach;?>
