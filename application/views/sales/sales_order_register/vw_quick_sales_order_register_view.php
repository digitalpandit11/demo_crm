                                        ...
                                        <div class="card-body">
                                            <form role="form" name="offer_form" enctype="multipart/form-data" action="<?php echo site_url('sales/sales_order_register/update_sales_order');?>" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label> Order Description <span style="color: #FF0000;">* Mandatory Field</span> </label>
                                                            <textarea class="form-control" id="order_descrption" name="order_descrption" rows="3" placeholder="Enter Order Description" required readonly></textarea>
                                                        </div>
                                                    </div>

                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label> Select Employee <span style="color: #FF0000;">* Mandatory Field</span> </label>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" style="width: 100%;" id="special_customer" name="special_customer" readonly >
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2bs4" style="width: 100%;" id="sales_order_type" name="sales_order_type" required readonly disabled>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="salutation" name="salutation" rows="3" placeholder="Enter Salutation" required readonly>Dear Sir/Madam, We are pleased to confirm price schedule for your requirement as follows</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="price_basis" id="price_basis" class="form-control" size="50" value="Ex-Works" required readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="transport_insurance" name="transport_insurance" rows="3" placeholder="Enter Transportation & Insurance" readonly>In Buyers Scope</textarea>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="tax" name="tax" rows="3" placeholder="Enter Tax" readonly>GST Extra As per applicable rate</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="delivery_schedule" name="delivery_schedule" rows="3" placeholder="Enter Delivery Schedule" readonly>Within 2 -3 weeks</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="mode_of_payment" name="mode_of_payment" rows="3" placeholder="Enter Mode Of Payment" readonly>By Cheque/NEFT</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="mode_of_transport" name="mode_of_transport" rows="3" placeholder="Enter Mode Of Transport" readonly>By Road through reputed transport on freight paid basis</textarea>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="packing_forwarding" name="packing_forwarding" rows="3" placeholder="Enter Packing & Forwarding Charges" readonly>Included</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="guarantee_warrenty" name="guarantee_warrenty" rows="3" placeholder="Enter Guarantee/Waranty" readonly>12 months from date of dispatch</textarea>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="payment_term" name="payment_term" rows="3" placeholder="Enter Payment Term" readonly>100% within 30 days after receipt of material</textarea>
                                                        </div>
                                                    </div>
                                                                   ...
                                                                   <table id="example1" class="table table-bordered table-striped">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <textarea class="form-control" id="product_description" name="product_description" style="width: 300px;" readonly rows="3" placeholder="Enter Product Description" onchange="change_ProductDescription(this);"><?php echo $row->product_custom_description;?></textarea>   
                                                                                </td>
                                                                                <td>
                                                                                    <input type="text" class="form-control" value="<?php echo $row->delivery_period;?>" id="offer_product_delivery_period" readonly name="offer_product_delivery_period" placeholder="Enter Delivery Period" style="width: 200px;" onchange="change_DeliveryPeriod(this);">    
                                                                                </td>
                                                                                <td>
                                                                                    <input type="text" class="form-control" value="<?php echo $row->product_warranty;?>" readonly id="product_warranty" name="product_warranty" placeholder="Enter Warranty" style="width: 150px;" onchange="change_Warranty(this);">   
                                                                                </td>
                                                                                <td>
                                                                                    <input type="text" class="form-control" readonly value="<?php echo $row->price;?>" id="product_price" name="product_price" placeholder="Enter Price" style="width: 100px;" onchange="change_Price(this);">   
                                                                                </td>
                                                                                <td>
                                                                                    <input type="text" class="form-control" readonly value="<?php echo $row->rfq_qty;?>" id="product_qty" name="product_qty" placeholder="Enter Qty" style="width: 100px;" onchange="change_ProductQty(this);">   
                                                                                </td>
                                                                                <td><?php echo $product_basic_value;?></td>
                                                                                <td>
                                                                                    <input type="text" class="form-control" readonly value="<?php echo $row->discount;?>" id="product_dis_per" name="product_dis_per" placeholder="Enter Discount%" style="width: 100px;" onchange="change_ProductDisPercentage(this);">
                                                                                </td>
                                                                   ...
                                                                   <table id="accessories_details_table" class="table table-bordered table-striped">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><?php echo $product_name;?><br><br><?php echo $product_id;?><br><br><?php echo $product_hsn_code;?></td>
                                                                                <td>
                                                                                    <input type="text" class="form-control" value="<?php echo $row->price;?>" id="product_price" name="product_price" readonly placeholder="Enter Price" style="width: 100px;" onchange="change_accessories_Price(this);">   
                                                                                </td>
                                                                                <td>
                                                                                    <input type="text" class="form-control" value="<?php echo $row->qty;?>" id="product_qty" name="product_qty" readonly placeholder="Enter Qty" style="width: 100px;" onchange="change_accessories_Qty(this);">   
                                                                                </td>
                                                                                <td><?php echo $product_basic_value;?></td>
                                                                                <td>
                                                                                    <input type="text" class="form-control" value="<?php echo $row->discount;?>" id="product_dis_per" name="product_dis_per"  readonlyplaceholder="Enter Discount%" style="width: 100px;" onchange="change_accessories_DisPercentage(this);">
                                                                                </td>
