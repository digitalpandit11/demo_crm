...
<html>
    <head>
        ...
        <title>Pending Sales Order Register</title>
                        ...
                        <div class="container-fluid">
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Pending Sales Order Register</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_pending_sales_order_data'?>">Pending Sales Order Register</a>
                                            </li>
                                        </ol>
                                    </div>      
                                </div>   
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">Pending Sales Order Register</h3>
                                        </div>
                                        <div class="card-body">
                                            <div  class="table-responsive">
                                                <table id="example1" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $no = 0;
                                                            foreach ($pending_sales_order as $row):
                                                                $no++;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <a href="<?php echo site_url('update_pending_sales_order_data/'.$entity_id);?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a> 
                                                                    <?php } ?>

                                                                    <?php if($offer_id == Null){ ?>
                                                                    <a href="<?php echo site_url('update_pending_sales_order_without_offer/'.$entity_id);?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a> 
                                                                    <?php } ?>
                                                                </div> 
                                                            </td>
                                                        </tr>
