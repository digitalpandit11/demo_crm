                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Update Sales Orders</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                    ...
                    $.ajax({
                        ...
                        success : function(data){
                            $.each(data, function(i, item){
                                ...
                                $('[name="offer_product_delivery_period"]').val(data[i].delivery_period);
        ...
        <script>
           $(function()
           {
                $("#product_checkbox_submited").on('click', function(event){
                    ...
                    var delivery_period = document.getElementById('offer_product_delivery_period').value;
