...
<html>
    <head>
        ...
        <title>Rejected Order Register</title>
                        ...
                        <div class="container-fluid">
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Rejected Order Register</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_all_rejected_sales_order_data'?>">Rejected Sales Order Register</a>
                                            </li>
                                        </ol>
                                    </div>      
                                </div>   
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">Rejected Sales Order Register</h3>
                                        </div>
                                        <div class="card-body">
                                            <div  class="table-responsive">
                                                <table id="example1" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $no = 0;
                                                            foreach ($rejected_sales_order as $row):
                                                                $no++;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row->order_execution_status_remark;?></td>
                                                            <td>
                                                                <div class="btn-group">
                                                                    <?php if($offer_id != Null){ ?>
                                                                    <a href="<?php echo site_url('update_rejected_sales_order_data/'.$entity_id);?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a> 
                                                                    <?php } ?>

                                                                    <?php if($offer_id == Null){ ?>
                                                                    <a href="<?php echo site_url('update_rejected_sales_order_without_offer_data/'.$entity_id);?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a> 
                                                                    <?php } ?>
                                                                </div> 
                                                            </td>
                                                        </tr>
