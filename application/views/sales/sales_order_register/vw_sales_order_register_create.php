...
<html>
    ...
    <body class="hold-transition sidebar-mini">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3" style="display: none;">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="customer_id" id="customer_id" class="form-control"  size="50" placeholder="Enter Enquiry Number" readonly>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label> Gst No </label>
                                                                            <input type="text" name="ship_to_gst_no" id="ship_to_gst_no" class="form-control" size="50" placeholder="Customer Gst No" readonly>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label> Gst No </label>
                                                                            <input type="text" name="bill_to_gst_no" id="bill_to_gst_no" class="form-control" size="50" placeholder="Customer Gst No" readonly>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="order_descrption" name="order_descrption" rows="3" placeholder="Enter Enquiry Description" required></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2bs4" style="width: 100%;" id="special_customer" name="special_customer" required>
                                                                <option value="">Not Selected</option>
                ...
                $.ajax({
                    ...
                    success: function(data){
                        $.each(data, function(i, item){
                            console.log(data);
                            $val = 
                            $('[name="customer_bill_to_contact_person"]').val(data[i].Bill_to_contact_person);
        ...
        <!-- <script type="text/javascript">
            $(document).ready(function(){
                //call function get data edit
                get_customer_ship_to_data();

                //load data for edit
                function get_customer_ship_to_data(){
                    var customer_id = $('[name="customer_id"]').val();
                    alert(customer_id);
                    
                    $.ajax({
                        url : "<?php echo site_url('sales/sales_order_register/get_customer_ship_to_data_by_id');?>",
                        method : "POST",
                        ...
                        success : function(data){
                            $.each(data, function(i, item){
                                console.log(data);
                                $val =
                                $('[name="ship_to_customer_id"]').val(data[i].party_name).trigger('change');
        ...
        <script type="text/javascript">
            ...
            function ship_to_contact_personsss(item)
            {
               ...
               var ship_to_contact_person = item.value;
                ...
                $.ajax({
                    url : "<?php echo site_url('sales/sales_order_register/update_ship_to_contact_person_edit_page');?>",
                    method : "POST",
                    data : {'offer_entity_id': offer_entity_id,
        ...
        <script type="text/javascript">
            ...
            function ship_to_addressss(item)
            {
               ...
               // alert(ship_to_email_id);
                ...
                $.ajax({
                    url : "<?php echo site_url('sales/sales_order_register/update_ship_to_address_edit_page');?>",
                    method : "POST",
                    data : {'offer_entity_id': offer_entity_id,
        ...
        <script type="text/javascript">
            ...
            function bill_to_contact_personsss(item)
            {
               ...
               var bill_to_contact_person = item.value;
                ...
                $.ajax({
                    url : "<?php echo site_url('sales/sales_order_register/update_bill_to_contact_person_edit_page');?>",
                    method : "POST",
                    data : {'offer_entity_id': offer_entity_id,
        ...
        <script type="text/javascript">
            ...
            function bill_to_addressss(item)
            {
               ...
               // alert(ship_to_email_id);
                ...
                $.ajax({
                    url : "<?php echo site_url('sales/sales_order_register/update_bill_to_address_edit_page');?>",
                    method : "POST",
                    data : {'offer_entity_id': offer_entity_id,
