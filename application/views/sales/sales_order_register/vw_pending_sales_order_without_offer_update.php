                                ...
                                <div class="card-header" >
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">Approve Sales Order Details Of Id :- <?php  echo $entity_id; ?> </li>
                                        </ol>
                                    </div>      
                                </div>   
                            </div>
                                            ...
                                            <form role="form" name="offer_form" enctype="multipart/form-data" action="<?php echo site_url('sales/sales_order_register/approve_sales_order');?>" method="post">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="ship_to_company_name" id="ship_to_company_name" class="form-control" size="50" placeholder="Enter Ship To Company" onchange="ship_to_company_name_change(this);" readonly>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="ship_to_contact_person" id="ship_to_contact_person" class="form-control" size="50" placeholder="Customer Contact Person" onchange="change_ship_to_contact_person(this);" required readonly>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="ship_to_email_id" id="ship_to_email_id" class="form-control" size="50" placeholder="Customer Email Id" onchange="change_ship_to_email_id(this);" required readonly>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea class="form-control" id="ship_to_address" name="ship_to_address" rows="3" placeholder="Enter Ship To Address" onchange="change_ship_to_address(this);" required readonly></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="ship_to_contact_number" id="ship_to_contact_number" class="form-control" size="50" placeholder="Customer Contact Number" onchange="change_ship_to_contact_number(this);" required readonly>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="ship_to_gst_number" id="ship_to_gst_number" class="form-control" size="50" placeholder="Customer GST Number" onchange="change_ship_to_gst_number(this);" readonly>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="bill_to_company_name" id="bill_to_company_name" class="form-control" size="50" placeholder="Enter Bill To Company" onchange="bill_to_company_name_change(this);" readonly>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label> Contact Person </label>
                                                                            <input type="text" name="bill_to_contact_person" id="bill_to_contact_person" class="form-control" size="50" placeholder="Customer Contact Person" onchange="change_bill_to_contact_person(this);" required readonly>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label> Customer Email Id </label>
                                                                            <input type="text" name="bill_to_email_id" id="bill_to_email_id" class="form-control" size="50" placeholder="Customer Email Id" onchange="change_bill_to_email_id(this);" required readonly>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea class="form-control" id="bill_to_address" name="bill_to_address" rows="3" placeholder="Enter Bill To Address" onchange="change_bill_to_address(this);" required readonly></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label> Contact Number </label>
                                                                            <input type="text" name="bill_to_contact_number" id="bill_to_contact_number" class="form-control" size="50" placeholder="Customer Contact Number" onchange="change_bill_to_contact_number(this);" required readonly>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label> GST Number </label>
                                                                            <input type="text" name="bill_to_gst_number" id="bill_to_gst_number" class="form-control" size="50" placeholder="Customer GST Number" onchange="change_bill_to_gst_number(this);" readonly>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" style="width: 100%;" id="special_customer" name="special_customer" readonly>
                                                                ...
                                                                <option value="5" selected>X-Not Specified</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <!-- <select class="form-control select2bs4" style="width: 100%;" id="order_terms_condition" name="order_terms_condition" required>
                                                                <option value="">Not Selected</option>
                                                                <option value="1">A</option>
                                                                <option value="2">B</option>
                                                            </select> -->
                                                            <input type="text" name="terms_conditions" id="terms_conditions" class="form-control" placeholder="Enter Terms & Condition" size="50" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="delivery_period" id="delivery_period" class="form-control" placeholder="Enter Delivery Period" size="50" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label> Freight </label>
                                                            <select class="form-control" style="width: 100%;" id="order_freight" name="order_freight" readonly>
                                                                <option value="">Not Selected</option>
                                                    ...
                                                    <div class="col-sm-3" id="Freight_charges_form" style="display: none">
                                                        <div class="form-group">
                                                            <label style="color: #FF0000;"> Freight Charges *</label>
                                                            <input type="text" name="freight_charges" id="freight_charges" class="form-control" placeholder="Enter Freight Charges" size="50" readonly>
                                                        </div>
                                                    </div> 
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" style="width: 100%;" id="order_pf" name="order_pf" readonly>
                                                                <option value="">Not Selected</option>
                                                     ...
                                                     <div class="col-sm-3" id="Packing_forwarding_form" style="display: none">
                                                        <div class="form-group">
                                                            <label style="color: #FF0000;"> P & F Charges *</label>
                                                            <input type="text" name="packing_forwarding_charges" id="packing_forwarding_charges" class="form-control" placeholder="Enter Packing & Forwarding Charges" size="50" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" style="width: 100%;" id="order_insurance" name="order_insurance" readonly>
                                                                <option value="">Not Selected</option>
                                                     ...
                                                     <div class="col-sm-3" id="Insurance_form" style="display: none">
                                                        <div class="form-group" readonly>
                                                            <label style="color: #FF0000;"> Insurance Charges *</label>
                                                ...
                                                <!-- <div class="row">
                                                    ...
                                                    <div class="col-sm-4" id="Rejection_reason_form" style="display: none">
                                                        <div class="form-group">
                                                            <label style="color: #FF0000;"> Rejection Reason *</label>
                                                            <textarea class="form-control" id="rejected_reason" name="rejected_reason" rows="3" placeholder="Enter Order Rejection Reason"></textarea>
                                                        </div>
                                                    </div>
                                                </div> -->
