                        ...
                        <div class="container-fluid">
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Sales Order Register</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div>
                                            ...
                                            <div class="btn-group" style="margin-top: 15px; margin-left: 15px;">
                                                <a href="create_quick_sales_order" class="btn btn-block btn-primary">
                                                Quick Sales Order
                                                </a>
                                            </div>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            ...
                                                            foreach ($order_details as $row):
                                                                ...
                                                                $quick_so_status = $row->quick_so_status;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><b><?php echo $row->customer_ship_to_name;?></b></td>
                                                            <td><?php echo $row->customer_ship_to_contact_person;?></td>
                                                            <td><?php echo $row->customer_ship_to_contact_person_no;?></td>
                                                            <td><?php echo $row->emp_first_name;?></td>
                                                            <td><?php echo date("d-m-Y", strtotime($row->sales_order_date));?></td>
                                                            <td>
                                                                <div class="btn-group">

                                                                    <a href="<?php echo site_url('create_purchase_order_against_sales_order/'.$row->entity_id);?>" class="btn btn-sm btn-danger" onclick="return confirm('Are You Sure ?')"><i class="fas fa-plane"></i></a>
                                                                    ...
                                                                    <?php if($offer_id == Null AND $quick_so_status == Null){ ?>
                                                                    ...
                                                                    <?php if($offer_id == Null AND $quick_so_status == 1){ ?>
                                                                    <a href="<?php echo site_url('update_quick_sales_order_data/'.$entity_id);?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
                                                                    <?php } ?>
                                                                    ...
                                                                    <?php if($offer_id == Null AND $quick_so_status == 1){ ?>
                                                                    <a href="<?php echo site_url('view_quick_sales_order_data/'.$entity_id);?>" class="btn btn-sm btn-success"><i class="fas fa-eye"></i></a>
                                                                    <?php } ?>

                                                                    <a href="<?php echo site_url('set_duplicate_order/'.$entity_id);?>" class="btn btn-sm btn-danger"><i class=""></i><b>D</b></a>
