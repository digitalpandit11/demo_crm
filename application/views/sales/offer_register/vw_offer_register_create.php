																...
																<tbody>
																	...
																	?>
																		<tr>
																			...
																			<td>
																				<textarea class="form-control product_custom_part_no" style="width: 200px;" rows="1" onchange="save_product_line(this)"><?php if ($product_custom_part_no) {
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			function get_data_edit() {
				...
				$.ajax({
					url: "<?php echo site_url('sales/offer_register/get_offer_details_by_id'); ?>",
					method: "POST",
					data: {
						entity_id: entity_id
					},
					...
					success: function(data) {
						$.each(data, function(i, item) {
							...
							$('[name="offer_source"]').val(data[i].enquiry_source).trigger('change');
			...
			if (hsn_code != "" && hsn_percentage != "") {
				$.ajax({
					...
					data: {
						...
						'enquiry_entity_id': enquiry_entity_id,
		...
		$(function() {
			$("#product_checkbox_submited_new").on('click', function(event) {
				...
				if (customer_name != "" && contact_id != "" && product_checkbox != "") {
					...
					$.ajax({
						url: "<?php echo site_url('sales/offer_register/update_offer_from_enquiry'); ?>",
						type: 'POST',
						data: {
							'enquiry_entity_id': enquiry_entity_id,
