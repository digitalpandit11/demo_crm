                                                ...
                                                <div class="row">
                                                    ...
                                                    <!-- <div class="col-sm-2">
                                                        <div>
                                                            <div style="margin-top: 30px;">
                                                                <button type="button" class="btn btn-block btn-success" data-toggle="modal" data-target="#modal-panel">
                                                                  Swap Details
                                                                </button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="contact_person_view_name" id="contact_person_view_name" class="form-control" readonly size="50" placeholder="Contact Person">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="offer_company_name" id="offer_company_name" class="form-control" size="50" placeholder="Customer Name" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="enquiry_descrption" name="enquiry_descrption" rows="3" placeholder="Enter Quotation Description" readonly></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="salutation" name="salutation" rows="3" placeholder="Enter Salutation" readonly></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2bs4" style="width: 100%;" id="offer_type" name="offer_type" disabled>
                                                                <option value="">Not Selected</option>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" name="offer_date" id="offer_date" class="form-control" size="50" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="price_basis" id="price_basis" class="form-control" size="50" readonly>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="validity" name="validity" rows="3" placeholder="Enter Validity" readonly></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2bs4" style="width: 100%;" id="price_condition" name="price_condition" disabled>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="your_reference" name="your_reference" rows="3" placeholder="Enter Your Reference" readonly></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                                   ...
                                                                   <table id="example1" class="table table-bordered table-striped">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <select class="form-control select2bs4 product_make" id="product_make" name="product_make" placeholder="Enter Product Make" style="width: 100px;" disabled>
                                                                                ...
                                                                                <td>
                                                                                    <textarea class="form-control product_description"  name="product_description" disabled style="width: 150px;" rows="3" placeholder="Enter Product Description" onchange="save_product_line(this)"><?php echo $P_Name;?></textarea>   
                                                                                </td>
                                                                                <!-- <td>
                                                                                ...
                                                                                <td>
                                                                                    <input type="text" class="form-control product_price" value="<?php echo $row->price;?>"  name="product_price" placeholder="Enter Price" disabled style="width: 100px;" onchange="save_product_line(this)">   
                                                                                    
                                                                                </td>
                                                                                <td>
                                                                                    <input type="text" class="form-control product_qty" value="<?php echo $row->rfq_qty;?>"  name="product_qty" placeholder="Enter Qty" disabled style="width: 100px;" onchange="save_product_line(this)">   
                                                                                </td>
                                                                                <td >
                                                                                ...
                                                                                <td>
                                                                                    <input type="text" class="form-control discount_percentage" value="<?php echo $row->discount;?>" name="discount_percentage" placeholder="Enter Discount%" disabled style="width: 100px;" onchange="save_product_line(this)">
                                                                                </td>
                                                                                <td>
                                                                                    <select class="form-control select2bs4 discount_type" name="discount_type" placeholder="Select discount type" disabled style="width: 100px;" onchange="save_product_line(this)">
                                                                                ...
                                                                                <td>
                                                                                  ...
                                                                                  <td>
                                                                                  <input type="text" class="form-control unit_discounted_rate" name="unit_discounted_rate"  style="width: 100px;" value="<?php echo $row->unit_discounted_price;?>"readonly> </td>
                                                                                  <td >
                                                                                  <input type="text" class="form-control total_amount_without_gst" name="total_amount_without_gst"  value="<?php echo $row->total_amount_without_gst;?>"style="width: 100px;" readonly> </td>
                                                                                  </td>
                                                                                <td>
                                                                                    <select class="form-control hsn_id" disabled style="width: 150px;" name="hsn_id" onchange="save_product_line(this)">
                                                                                        <option value="">Not Selected</option>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    } ?>" name="gst_percentage" placeholder="Enter GST Percentage" disabled style="width: 100px;" onchange="save_product_line(this)"> 
                                                                                ...
                                                                                <td>
                                                                                    <textarea class="form-control product_remark" name="product_remark" disabled style="width: 300px;" rows="3" placeholder="Enter Product Remark"  onchange="save_product_line(this)"><?php echo $row->remark;?></textarea>   
                                                                                </td>

                                                                                <td>
                                                                                    <textarea class="form-control internal_remark" name="internal_remark" disabled style="width: 300px;" rows="3" placeholder="Enter Product Internal Remark" onchange="save_product_line(this)"> <?php echo $row->internal_remark;?> </textarea>   
                                                                                </td>
                                                                                <!-- <td>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" disabled id="offer_note" name="offer_note" rows="3" placeholder="Enter Note"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" name="offer_close_date" id="offer_close_date" class="form-control" size="50" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" style="width: 100%;" id="offer_status" name="offer_status" readonly>
                                                                <option value="" onclick="hideOfferStatus()">Not Selected</option>
                                                                <!-- <option value="1">Pending Offer Creation</option> -->
                                                                <option value="2" onclick="hideOfferStatus()">Active</option>
                                                                <!-- <option value="3">Order Created</option> -->
                                                                <option value="4" onclick="showOfferStatus()">Loss</option>
                                                                <!-- <option value="5" onclick="showOfferStatus()">Regrated</option> -->
                                                                <option value="6" onclick="hideOfferStatus()">Win</option>
                                                                <!-- <option value="7" onclick="hideOfferStatus()">On Hold</option> -->
                                                                <option value="7" onclick="showOfferStatus()">InActive</option>
                                                                <option value="8" onclick="hideOfferStatus()">A</option>
                                                                <option value="9" onclick="hideOfferStatus()">B</option>
                                                    ...
                                                    <div class="col-sm-4" id="Offer_reason_text" >
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="offer_reason" id="offer_reason" class="form-control" placeholder="Enter Quotation Loss/Regrated Reason" size="50" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="date" name="tracking_date" id="tracking_date" value="" class="form-control" size="50">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="offer_value" id="offer_value" class="form-control" value="" size="50" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
  ...
  $.ajax({
        ...
        <script type="text/javascript">
            $(document).on('click', '#update_new_product', function () {
                ...
                if(enquiry_entity_id != "" && customer_name != "" && contact_id != "" && product_id !="" && product_name != "" && product_long_desc != "" && hsn_code != "" && product_make != "" && category_id !="" && product_unit !="" && product_price !="")
                {   
                    $.ajax({
                            url : "<?php echo site_url('sales/offer_register/update_new_product_with_offer');?>",
                            type : "POST",
                            data: {'enquiry_entity_id': enquiry_entity_id,'enquiry_descrption': enquiry_descrption, 'employee_id': employee_id, 'offer_type': offer_type, 'offer_date': offer_date, 'dispatch_address': dispatch_address, 'delivery_instruction': delivery_instruction, 'packing_forwarding': packing_forwarding, 'payment_term': payment_term, 'special_instruction': special_instruction, 'price_condition': price_condition, 'salutation': salutation, 'price_basis': price_basis, 'transport_insurance': transport_insurance, 'tax': tax, 'delivery_schedule': delivery_schedule, 'mode_of_payment': mode_of_payment, 'your_reference': your_reference, 'customer_name': customer_name, 'contact_id': contact_id, 'validity': validity, 'guarantee_warrenty': guarantee_warrenty, 'product_id': product_id, 'product_name': product_name, 'hsn_code': hsn_code, 'product_make': product_make, 'category_id': category_id, 'product_long_desc': product_long_desc, 'product_warranty': product_warranty, 'product_unit': product_unit, 'product_price': product_price, 'internal_remark': internal_remark, 'offer_company_name': offer_company_name},
                            success : function(data) {
                                location.reload();
                            },
                            error : function(data) {
        ...
        <script>
           $(function()
           {
                $("#send_mail").on('click', function(event)
                {
                    ...
                    if(enquiry_entity_id != "" && enquiry_descrption != "" && employee_id != "" && salutation !="" && offer_type != "" && offer_date !="" && price_basis != "" && transport_insurance != "" && tax !="" && delivery_schedule !="" && mode_of_payment !="" && packing_forwarding !="" && payment_term !="" && mail_to !="" && mail_cc !="" && mail_bcc !="")
                    { 

                        $.ajax({
                            url:"<?php echo site_url('sales/offer_register/save_offer_send_mail');?>",
                            type: 'POST',
                            data: {'enquiry_entity_id': enquiry_entity_id , 'enquiry_descrption': enquiry_descrption , 'employee_id': employee_id , 'salutation': salutation , 'offer_type': offer_type , 'offer_date': offer_date , 'price_basis': price_basis , 'transport_insurance': transport_insurance , 'tax': tax , 'delivery_schedule': delivery_schedule , 'mode_of_payment': mode_of_payment , 'dispatch_address': dispatch_address , 'delivery_instruction': delivery_instruction , 'packing_forwarding': packing_forwarding , 'payment_term': payment_term , 'special_instruction': special_instruction , 'price_condition': price_condition , 'your_reference': your_reference , 'offer_note': offer_note , 'mail_to': mail_to , 'mail_cc': mail_cc , 'mail_bcc': mail_bcc , 'offer_close_date': offer_close_date},
                                success: function(data){
        ...
        <script type="text/javascript">
            ...
            $('#select_both_swap').click(function(){
                ...
                $.ajax({
                    ...
                    type:"POST",
                    data:{'customer_id':customer_id,'contact_person':contact_person},
                    dataType:'json',
                    async:true,
                    success:function(data){
                        //$('#modal-panel').fadeOut();       
        ...
        <script type="text/javascript">
            $('#save_new_customer').click(function(){
                ...
                $.ajax({
                    ...
                    method:'POST',
                    data:{
                        'enquiry_id':enquiry_id,'contact_person_id':cont_id,'customer_name':customer_name,'customer_type':customer_type,'address':address,'state_id':state_id,'city_id':city_id,'state_code':state_code,'customer_pin_code':customer_pin_code,'customer_gst_number':customer_gst_number,'customer_pan_number':customer_pan_number
                    },
                    dataType:'json',
                    success:function (d) {
                        window.location.reload();
                ...
                $("#save_offer").on('click', function(event)
                {
                    ...
                    if(customer_name != "" && contact_id != "")
                    {
                        ...
                        $.ajax({
                            ...
                            type: 'POST',
                            data: {'enquiry_entity_id': enquiry_entity_id,'enquiry_descrption': enquiry_descrption, 'employee_id': employee_id, 'offer_type': offer_type, 'offer_date': offer_date, 'dispatch_address': dispatch_address, 'delivery_instruction': delivery_instruction, 'packing_forwarding': packing_forwarding, 'payment_term': payment_term, 'special_instruction': special_instruction, 'price_condition': price_condition, 'salutation': salutation, 'price_basis': price_basis, 'transport_insurance': transport_insurance, 'tax': tax, 'delivery_schedule': delivery_schedule, 'mode_of_payment': mode_of_payment, 'your_reference': your_reference, 'customer_name': customer_name, 'contact_id': contact_id, 'validity': validity, 'guarantee_warrenty': guarantee_warrenty, 'offer_company_name': offer_company_name, 'offer_note': offer_note, 'offer_close_date': offer_close_date},
                            success: function(data){
                                window.location.href = data;
                            },
                            error: function(){
