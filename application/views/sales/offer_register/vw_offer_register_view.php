				...
				<div class="container-fluid">
					...
					<div class="card">
						<div class="card-header">
							<h1 class="card-title">View Quotation</h1>
							<div class="col-sm-6">
								<br><br>
								<ol class="breadcrumb">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="card card-primary">
								...
								<div class="card-body">
									<form role="form" name="offer_form" enctype="multipart/form-data" action="" method="post">
										...
										<div class="row">
											...
											<div class="col-sm-4">
												<div class="form-group">
													...
													<select class="form-control select2bs4" style="width: 100%;" id="contact_id" name="contact_id" required disabled>
										...
										<div class="row">
											<div class="col-sm-4">
												<div class="form-group">
													...
													<select class="form-control select2bs4" style="width: 100%;" id="offer_for" name="offer_for" disabled>
											...
											<div class="col-sm-4">
												<div class="form-group">
													...
													<select class="form-control select2bs4" style="width: 100%;" id="offer_for_info" name="offer_for_info" disabled>
														<option value="">Select Product Group</option>
										...
										<div class="row">
											...
											<div class="col-sm-4">
												<div class="form-group">
													...
													<select class="form-control select2bs4" style="width: 100%;" id="offer_source" name="offer_source" disabled>
										...
										<div class="row">
											...
											<div class="col-sm-4">
												<div class="form-group">
													...
													<select class="form-control select2bs4" style="width: 100%;" id="rm_employee_id" name="rm_employee_id" disabled>
														<option value="">Not Selected</option>
														<?php foreach ($employee_list as $row) : ?>
															<option value="<?php echo $row->entity_id; ?>"><?php echo $row->Emp_name; ?></option>
														<?php endforeach; ?>
											...
											<div class="col-sm-4">
												<div class="form-group">
													...
													<select class="form-control select2bs4" style="width: 100%;" id="principle_engg_id" name="principle_engg_id" disabled>
														<option value="">Not Selected</option>
																...
																<tbody id="driverbody">
																	...
																	?>
																		<tr>
																			...
																			<td>
																				<select class="form-control select2bs4 product_make" id="product_make" name="product_make" placeholder="Enter Product Make" style="width: 100px;" onchange="save_product_line(this)" disabled >
																			...
																			<td>
																				<textarea class="form-control product_custom_part_no" name="product_custom_part_no" style="width: 200px;" rows="1" onchange="save_product_line(this)" readonly><?php if ($product_custom_part_no) {
																			...
																			<td>
																				<textarea class="form-control product_description" name="product_description" style="width: 150px;" rows="3" placeholder="Enter Product Description" onchange="save_product_line(this)" readonly><?php if ($product_custom_description) {
																			...
																			<td>
																				<input type="text" class="form-control product_delivery_period" value="<?php echo $row->delivery_period; ?>" id="product_delivery_period" name="product_delivery_period" placeholder="Enter Delivery Period" style="width: 100px;" onchange="save_product_line(this);" readonly>
																			</td>
																			<td>
																				<input type="text" class="form-control product_current_stock" value="<?php echo $row->current_stock; ?>" id="product_current_stock" name="product_current_stock" placeholder="Enter Stock" style="width: 100px;" onchange="save_product_line(this);" readonly>
																			</td>
																			<td>
																				<input type="text" class="form-control product_price" value="<?php echo $row->price; ?>" name="product_price" placeholder="Enter Price" style="width: 100px;" onchange="save_product_line(this)" readonly>

																			</td>
																			<td>
																				<input type="text" class="form-control product_qty" value="<?php echo $row->rfq_qty; ?>" name="product_qty" placeholder="Enter Qty" style="width: 100px;" onchange="save_product_line(this)" readonly>
																			</td>
																			<td>
																			...
																			<td>
																				<input type="text" class="form-control discount_percentage" value="<?php echo $row->discount; ?>" name="discount_percentage" placeholder="Enter Discount%" style="width: 100px;" onchange="save_product_line(this)" readonly>
																			</td>
																			<td>
																				<select class="form-control select2bs4 discount_type" name="discount_type" placeholder="Select discount type" style="width: 100px;" onchange="save_product_line(this)" disabled>
																			...
																			<td>
																				<select class="form-control hsn_id" style="width: 150px;" name="hsn_id" onchange="save_product_line(this)" disabled>
																					<option value="">Not Selected</option>
																			...
																			<td>
																				<input type="text" class="form-control gst_percentage" value="<?php if ($row->gst_percentage == NULL) {
																																																			...
																																																			} ?>" name="gst_percentage" placeholder="Enter GST Percentage" style="width: 100px;" onchange="save_product_line(this)" readonly>
																			...
																			<td>
																				<textarea class="form-control product_remark" name="product_remark" style="width: 300px;" rows="3" placeholder="Enter Product Remark" onchange="save_product_line(this)" readonly><?php echo $row->remark; ?></textarea>
																			</td>

																			<td>
																				<textarea class="form-control internal_remark" name="internal_remark" style="width: 300px;" rows="3" placeholder="Enter Product Internal Remark" onchange="save_product_line(this)" readonly> <?php echo $row->internal_remark; ?> </textarea>
																			</td>
																			<td>
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<textarea name="offer_terms_condition" id="offer_terms_condition" class="form-control" rows="5" placeholder="Enter Terms Conditions" readonly>Prices and stock are valid till stock last
...
To check stock, whatsapp on below number 7796962133</textarea>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<textarea class="form-control" id="offer_note" name="offer_note" rows="5" placeholder="Enter Note" readonly></textarea>
												</div>
											</div>
										</div>
											...
											<div class="row">
												<div class="col-sm-4">
													<div class="form-group">
														...
														<select class="form-control" style="width: 100%;" id="offer_status" name="offer_status" disabled>
															<option value="">Not Selected</option>
												...
												<div class="col-sm-4" id="Offer_reason_text">
													<div class="form-group">
														...
														<select class="form-control" style="width: 100%;" id="offer_reason" name="offer_reason" disabled>
								...
								<div class="card-body">
									...
									<div class="card-body">
													<center>
														<a href="<?=base_url('vw_my_offer_data');?>" class="btn btn-success toastrDefaultSuccess">
															Back
														</a>
													</center>
												</div>
