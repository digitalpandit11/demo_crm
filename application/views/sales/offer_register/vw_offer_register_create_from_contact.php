    ...
    <body class="hold-transition sidebar-mini">
        <div class="wrapper">
            ...
            <?php 
                ...
                // $this->db->from('offer_register');
                // $this->db->where('entity_id', $offer_master_lastid);
                // $query = $this->db->get();
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <form role="form" name="offer_form" enctype="multipart/form-data" action="<?php echo site_url('sales/offer_register/save_offer');?>" method="post">
                                                ...
                                                <input type="hidden" id="offer_master_lastid" name="offer_master_lastid" value="<?php echo $offer_entity_id;?>" required>

                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label> Quotation Number </label>
                                                            <input type="text" name="offer_number" id="offer_number" class="form-control"  size="50" placeholder="Enter Quotation Number" value = "<?php //echo $offer_common_data->offer_no;?>" readonly>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label> Customer Name </label>
                                                            <input type="text" name="customer_view_name" id="customer_view_name" class="form-control" readonly size="50" value = "<?php echo $customer_data->customer_name;?>" placeholder="Customer Name">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="contact_person_view_name" id="contact_person_view_name" class="form-control" readonly size="50" value = "<?php echo $customer_data->contact_person;?>"  placeholder="Contact Person">
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label> Contact Person </label>
                                                                            <input type="text" name="enquiry_contact_person" id="enquiry_contact_person" class="form-control" size="50"  value = "<?php echo $customer_data->contact_person;?>" placeholder="Customer Contact Person" readonly onchange="change_contact_person(this);">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="enquiry_email_id" id="enquiry_email_id" class="form-control" readonly size="50" value = "<?php echo $customer_data->email_id;?>"  placeholder="Customer Email Id" onchange="change_email_id(this);">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="enquiry_contact_number" id="enquiry_contact_number" class="form-control" readonly size="50"  value = "<?php echo $customer_data->first_contact_no;?>" placeholder="Customer Contact Number" onchange="change_contact_no(this);">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group">
                                                                            <label> State </label>
                                                                            <input type="text" name="enquiry_customer_state" id="enquiry_customer_state" class="form-control" size="50"  value = "<?php echo $customer_data->state_name;?>" placeholder="Customer State" readonly>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group">
                                                                            <label> City </label>
                                                                            <input type="text" name="enquiry_customer_city" id="enquiry_customer_city" class="form-control" size="50"  value = "<?php echo $customer_data->city_name;?>" placeholder="Customer City" readonly>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2bs4" style="width: 100%;" id="price_condition" name="price_condition">
                                                                <option value="1">Ex Works Pune</option>
                                                ...
                                                <div class="card-body">
                                                    <center>
                                                        ...
                                                        <a data-toggle="modal" data-target="#modal-customer-update" class="btn btn-primary" style="color: #ffff;">
        ...
        <div class="modal fade" id="modal_offer_save">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Save offer to proceed</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-body">
                        <p>Save Offer To Proceed</p>
                    </div>
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>   

                        <button data ="<?php echo site_url('update_offer_data/'.$offer_entity_id);?>" type="button" name="save_offer" id="save_offer" class="btn btn-primary">Save Offer</button>
                    </div>
                </div>
              <!-- /.modal-content -->
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
              $('#modal_offer_save').modal('show');
              $("#save_offer").on('click', function(event)
              {
                // $("#save_offer").attr("disabled", true);
                alert(1);
                // window.location.href = <?php echo site_url('update_offer_data/'.$offer_entity_id);?>;
              ...
              get_data_edit();
                ...
                function get_data_edit(){
                    var entity_id = $('[name="offer_master_lastid"]').val();
        ...
        <script>
            ...
            $(function()
            {
                $("#product_checkbox_submited_new").on('click', function(event)
                {
                    ...
                    var offer_entity_id = document.getElementById('offer_master_lastid').value;
                    ...
                    if(customer_name != "" && contact_id != "" && product_checkbox != "")
                    {
                        ...
                        $.ajax({
                            url:"<?php echo site_url('sales/offer_register/update_offer_from_contact');?>",
                            type: 'POST',
                            data: {'offer_entity_id': offer_entity_id, 'product_checkbox': product_checkbox,'enquiry_descrption': enquiry_descrption, 'employee_id': employee_id, 'offer_type': offer_type, 'offer_date': offer_date, 'dispatch_address': dispatch_address, 'delivery_instruction': delivery_instruction, 'packing_forwarding': packing_forwarding, 'payment_term': payment_term, 'special_instruction': special_instruction, 'price_condition': price_condition, 'salutation': salutation, 'price_basis': price_basis, 'transport_insurance': transport_insurance, 'tax': tax, 'delivery_schedule': delivery_schedule, 'mode_of_payment': mode_of_payment, 'your_reference': your_reference, 'customer_name': customer_name, 'contact_id': contact_id, 'validity': validity, 'guarantee_warrenty': guarantee_warrenty, 'offer_company_name': offer_company_name},
                            success: function(data){
                                location.reload();
                            },
                            error: function(){
