                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <form role="form" name="challan_form" enctype="multipart/form-data" action="<?php echo site_url('factory/material_issue_register/save_challan_data');?>" method="post">
