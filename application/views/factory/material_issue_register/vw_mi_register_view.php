                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">View Challan</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_challan_data'?>">Challan</a></li>
                                            <li class="breadcrumb-item">View Challan Details Of Id :- <?php  echo $entity_id; ?> </li>
                                        </ol>
                                    </div>      
                                </div>   
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <form role="form" name="challan_form" enctype="multipart/form-data" action="<?php echo site_url('factory/material_issue_register/view_challan_data');?>" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2bs4" style="width: 100%;" id="grn_id" name="grn_id" disabled>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control" id="challan_date" name="challan_date" disabled> 
                                                        </div>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="department" name="department" placeholder="Enter Department" disabled> 
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="contact_person" name="contact_person" placeholder="Enter Contact Person" disabled> 
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label> Comment </label>
                                                            <textarea class="form-control" id="comment" name="comment" rows="3" placeholder="Enter Comment" disabled></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="challan_amount" name="challan_amount" placeholder="Enter Challan Amount" disabled> 
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="challan_paid_amount" name="challan_paid_amount" placeholder="Enter Challan Paid Amount" disabled> 
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="challan_balance_amount" name="challan_balance_amount" placeholder="Enter Challan Balance Amount" disabled> 
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
