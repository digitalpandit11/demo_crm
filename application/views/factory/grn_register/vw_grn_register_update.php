    ...
    <body class="hold-transition sidebar-mini">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Update GRN</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_goods_receipt_note_data'?>">GRN</a></li>
                                            <li class="breadcrumb-item">Update GRN Details Of Id :- <?php  echo $entity_id; ?> </li>
                                        </ol>
                                    </div>      
                                </div>   
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <form role="form" name="grn_form" enctype="multipart/form-data" action="<?php echo site_url('factory/grn_register/update_grn');?>" method="post">
        ...
        <script type="text/javascript">
            function delete_attachment(d){
                var id=d;
                $.ajax({
                    url : "<?php echo site_url('factory/grn_register/delete_attachment');?>",
                    type : "POST",
                    data: {'id': id},
                    success : function(data) {
