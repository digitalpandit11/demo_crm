                ...
                $("#product_checkbox_submited").on('click', function(event){
                    ...
                    if(product_checkbox !="" && entity_id !="")
                    {
                        $.ajax({
                            ...
                            type: 'POST',
                            data: {'entity_id': entity_id, 'exp_delivery_date': exp_delivery_date,'order_date': order_date,'issued_by': issued_by,'issued_to': issued_to,'standard_note': standard_note,'urgency': urgency, 'order_descrption': order_descrption, 'product_checkbox': product_checkbox, 'po_no': po_no, 'po_date': po_date},
                                success : function(data) {
                                    data = data.trim();
                                    location.reload();
                                },
