                                                                   ...
                                                                   <table id="example1" class="table table-bordered table-striped">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <input type="text" class="form-control" value="<?php echo $row->work_order_qty;?>" id="product_qty" name="product_qty" placeholder="Enter Qty" style="width: 100px;" onchange="change_ProductQty(this);">   
                                                                                </td>
                                                                                <td>
                    ...
                    $.ajax({
                        ...
                        success : function(data){
                            $.each(data, function(i, item){
                                ...
                                //$('[name="workorder_type"]').val(data[i].workorder_type);
                ...
                $("#product_checkbox_submited").on('click', function(event){
                    ...
                    if(product_checkbox !="" && entity_id !="")
                    {
                        $.ajax({
                            ...
                            type: 'POST',
                            data: {'entity_id': entity_id, 'exp_delivery_date': exp_delivery_date,'order_date': order_date, 'order_descrption': order_descrption, 'product_checkbox': product_checkbox},
                                success : function(data) {
                                    data = data.trim();
                                    location.reload();
                                },
           ...
           $(document).on('click', '#confirm_order', function () {
                ...
                {    
                    $.ajax({
                        ...
                        type : "POST",
                        data: {'entity_id': entity_id, 'exp_delivery_date': exp_delivery_date,'order_date': order_date,'issued_by': issued_by,'issued_to': issued_to,'standard_note': standard_note,'urgency': urgency, 'order_descrption': order_descrption},
                        success : function(data) {
                            //location.reload();
