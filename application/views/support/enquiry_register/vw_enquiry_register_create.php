    ...
    <body class="hold-transition sidebar-mini">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <form role="form" name="enquiry_form" enctype="multipart/form-data" action="<?php echo site_url('support/enquiry_register/save_enquiry');?>" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">   
                                                            <label for="enquiry_attachment">Attachment</label>
                                                            <div class="input-group">
                                                                <div class="custom-file">
                                                                    <input type="file" class="custom-file-input" name="enquiry_attachment[]" multiple id="enquiry_attachment">
                                                                    <label class="custom-file-label" for="enquiry_attachment">Choose Attachment</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        <script type="text/javascript">
            ...
            $('#customer_id').change(function(){ 
                var id=$(this).val();
                $.ajax({
                    url : "<?php echo site_url('support/enquiry_register/get_contact_person');?>",
                    method : "POST",
                    data : {id: id},
                    async : true,
                    dataType : 'json',
            ...
            $('#contact_id').change(function(){
                var id=$(this).val();
                $.ajax({
                    url : "<?php echo site_url('support/enquiry_register/get_all_customer_data');?>",
                    method : "POST",
                    data : {id: id},
                    async : true,
                    dataType : 'json',
            ...
            $(document).on('click', '#add_address', function () {
                ...
                if(address_type != "" && address != "" && state_id != "" && city_id != "" && customer_pin_code != "" && state_code != "" && contact_person != "" && contact_person_email_id != "" && first_contact_no != "" && customer_name != "" && customer_type != "")
                {
                    $.ajax({
                            url : "<?php echo site_url('master/customer_master/save_address');?>",
                            type : "POST",
                            data: {'address_type': address_type , 'address': address , 'state_id': state_id , 'city_id': city_id , 'customer_pin_code': customer_pin_code , 'state_code': state_code , 'customer_gst_number': customer_gst_number , 'customer_pan_number': customer_pan_number , 'contact_person': contact_person , 'contact_person_email_id': contact_person_email_id , 'first_contact_no': first_contact_no , 'second_contact_no': second_contact_no , 'whatsup_no': whatsup_no , 'customer_name': customer_name , 'customer_type': customer_type},
                            success : function(data) {
                                data = data.trim();
                                location.reload();
                            },
