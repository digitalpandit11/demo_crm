                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">View Enquiry</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <form role="form" id="enquiry_form" name="enquiry_form" enctype="multipart/form-data" action="<?php echo site_url('support/enquiry_register/view_enquiry');?>" method="post">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="select2-purple">
                                                                <select class="select2" name="enquiry_product[]" id="enquiry_product" multiple="multiple" data-placeholder="Select A Product" data-dropdown-css-class="select2-purple" disabled style="width: 100%;">
                                                                    <?php foreach($product_list as $row):?>
                                                                        <option value="<?php echo $row->entity_id;?>" required><?php echo $row->Product_name;?></option>
                                                                    <?php endforeach;?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2bs4" style="width: 100%;" id="enquiry_urgency" disabled name="enquiry_urgency" required>
                                                                <option value="">Select</option>
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-radio">
                                                                        <input class="custom-control-input" type="radio" id="customRadio1" name="enquiry_status" checked="checked" value="1" disabled>
                                                                        <label for="customRadio1" class="custom-control-label">Offer Pending</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-radio">
                                                                        <input class="custom-control-input" type="radio" id="customRadio2" name="enquiry_status" value="2" disabled>
                                                                        <label for="customRadio2" class="custom-control-label">Offer Received</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-radio">
                                                                        <input class="custom-control-input" type="radio" id="customRadio3" name="enquiry_status" value="3" disabled>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-radio">
                                                                        <input class="custom-control-input" type="radio" id="customRadio4" name="enquiry_status" value="4" disabled>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label> Reason to Disqualify <span style="color: #FF0000;">* Mandatory</span></label>
                                                            <textarea class="form-control" id="rejected_reason" name="rejected_reason" disabled rows="3" placeholder="Enter Cancellation Reason"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                    ...
                    $.ajax({
                        ...
                        success : function(data){
                            $.each(data, function(i, item){
                                ...
                                if (data[i].enquiry_status == 2)
                                    $('#enquiry_form').find(':radio[name=enquiry_status][value="2"]').prop('checked', true);

                                if (data[i].enquiry_status == 3)
                                    $('#enquiry_form').find(':radio[name=enquiry_status][value="3"]').prop('checked', true);
                                if (data[i].enquiry_status == 4)
                                    $('#enquiry_form').find(':radio[name=enquiry_status][value="4"]').prop('checked', true);

                                $('[name="rejected_reason"]').val(data[i].enquiry_cancel_reason);
                            });
                        }
                    });
                }
