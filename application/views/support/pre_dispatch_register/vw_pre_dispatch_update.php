...
<html>
    <head>
        ...
        <title>Update Pre Dispatch</title>
    ...
    <body class="hold-transition sidebar-mini">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Update Pre Dispatch</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_predispatch_data'?>">Pre Dispatch</a></li>
                                            <li class="breadcrumb-item">Update Pre Dispatch Of Id :- <?php  echo $entity_id; ?> </li>
                                        </ol>
                                    </div>      
                                </div>   
                            </div>
        ...
        <script type="text/javascript">
            function delete_attachment(d){
                var id=d;
                $.ajax({
                    url : "<?php echo site_url('support/pre_dispatch_register/delete_attachment');?>",
                    type : "POST",
                    data: {'id': id},
                    success : function(data) {
