    ...
    <body class="hold-transition sidebar-mini">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Create Ticket</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_all_ticket_data'?>">Ticket Register</a></li>
                                            <li class="breadcrumb-item">Enter Ticket Details</li>
                                        </ol>
                                    </div>      
                                </div>   
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <form role="form" name="ticket_form" enctype="multipart/form-data" action="<?php echo site_url('support/ticket_register/save_ticket');?>" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="refrance_person" id="refrance_person" class="form-control" size="50" placeholder="Enter Refrance Person Name">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2bs4" style="width: 100%;" id="ticket_type" name="ticket_type" required>
                                                                ...
                                                                <option value="5">Technical Support - Field Service</option>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2bs4" style="width: 100%;" id="warrantee_status" name="warrantee_status"  required>
                                                                <option value="">Select Warrantee Status</option>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="warrantee_year" id="warrantee_year" class="form-control" size="50" placeholder="Enter Warrantee Year">
                                                        </div>
                                                    </div>
        ...
        <script type="text/javascript">
            ...
            $(document).on('click', '#add_address', function () {
                ...
                {
                    $.ajax({
                            url : "<?php echo site_url('support/ticket_register/save_address');?>",
                            type : "POST",
