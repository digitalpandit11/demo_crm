...
<html>
    <head>
        ...
        <title>All Tracking Record</title>
                        ...
                        <div class="container-fluid">
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Tracking Records</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_all_tracking_data'?>">Tracking Records</a>
                                            </li>
                                        </ol>
                                    </div>      
                                </div>   
