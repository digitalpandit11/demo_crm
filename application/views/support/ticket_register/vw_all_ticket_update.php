...
<html>
    ...
    <body class="hold-transition sidebar-mini">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Update All Ticket</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            ...
                                            <?php }elseif($ticket_type == 3){ ?>
                                                <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_ticket_technical_support_data'?>">Technical Support Ticket</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <form role="form" id="ticket_form" name="ticket_form" enctype="multipart/form-data" action="<?php echo site_url('support/ticket_register/update_all_ticket');?>" method="post">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-radio">
                                                                        <input class="custom-control-input" type="radio" id="customRadio1" name="ticket_status" value="1" onclick="hideR(); hidecd();">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-radio">
                                                                        <input class="custom-control-input" type="radio" id="customRadio2" name="ticket_status" value="2" onclick="hideR(); hidecd();">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-radio">
                                                                        <input class="custom-control-input" type="radio" id="customRadio3" name="ticket_status" value="3" onclick="hideR(); showcd();">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-radio">
                                                                        <input class="custom-control-input" type="radio" id="customRadio4" name="ticket_status" value="4" onclick="showR(); hidecd();">
                                                ...
                                                <div class="row">
                                                <div class="col-sm-4" id="close_date_form" style="display: none">
                                                        <div class="form-group">
                                                            <label> Close Date <span style="color: #FF0000;">* Mandatory</span></label>
                                                            <input type="date" class="form-control" id="close_date" name="close_date" placeholder="Select Close Date">
                                                        </div>
                                                    </div>
            ...
            $(document).on('click', '#move_ticket', function () {
                ...
                {   
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {'entity_id': entity_id , 'ticket_type' : ticket_type , 'management_decision' : management_decision},
                        success : function(data) {
                            data = data.trim();
        ...
        <script type="text/javascript">
            ...
            function showcd(){
               document.getElementById('close_date_form').style.display = "block";
            }

            function hidecd(){
                $('#close_date_form').hide();  
            }
        </script>
