                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <ol class="breadcrumb">
                                            ...
                                            <?php if($ticket_type == 1) {?>
                                                ...
                                                <li class="breadcrumb-item">View Warrantee Claims Of Id :- <?php  echo $entity_id; ?> </li>
                                            <?php }elseif($ticket_type == 2){ ?>
                                                ...
                                                <li class="breadcrumb-item">View Paid Service Of Id :- <?php  echo $entity_id; ?> </li>
                                            <?php }elseif($ticket_type == 3){ ?>
                                                ...
                                                <li class="breadcrumb-item">View Technical Support Of Id :- <?php  echo $entity_id; ?> </li>
                                            <?php }elseif($ticket_type == 4){ ?>
                                                <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_inhouse_data'?>">Inhouse Ticket</a></li>
                                                <li class="breadcrumb-item">View Inhouse Ticket Of Id :- <?php  echo $entity_id; ?> </li>
                                            <?php } ?>
                                        </ol>
                                    </div>      
                                </div>   
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="product_make" id="product_make" class="form-control" disabled size="50" placeholder="Enter Product Make">
                                                        </div>
                                                    </div>
