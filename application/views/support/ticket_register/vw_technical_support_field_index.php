...
<head>
	...
	<title>Technical Support - Field</title>
				...
				<div class="container-fluid">
					<div class="card">
						<div class="card-header">
							<h1 class="card-title">Technical Support (Field ) Tickets</h1>
							<div class="col-sm-6">
								<br><br>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url() . 'dashboard' ?>">Home</a></li>
									<li class="breadcrumb-item"><a href="<?php echo base_url() . 'vw_ticket_technical_support_field_data' ?>">Technical Support(Field) Tickets</a>
									</li>
								</ol>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Technical Support - Field  ISO Number (BBCPL-SER-F-03)</h3>
								</div>
								<div class="card-body">
											...
											<tbody>
												...
												?>
													<tr>
														...
														<td>
															<div class="btn-group">
																<a href="<?php echo site_url('view_ticket_data/' . $entity_id); ?>" class="btn btn-sm btn-success"><i class="fas fa-eye"></i></a>

																<a href="<?php echo site_url('update_ticket_data/' . $entity_id); ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
