                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">View Demo Test</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_demotest_data'?>">Demo Test</a></li>
                                            <li class="breadcrumb-item">View Demo Test Of Id :- <?php  echo $entity_id; ?> </li>
                                        </ol>
                                    </div>      
                                </div>   
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <form role="form" id="demotest_form" name="demotest_form" enctype="multipart/form-data" action="<?php echo site_url('support/demo_test_register/view_demo_test');?>" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="test_name" id="test_name" class="form-control" placeholder="Enter Test Name" disabled>
                                                        </div>
                                                    </div>
                                                </div>
