                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Create Demo Test</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_demotest_data'?>">Demo Test List</a></li>
                                            <li class="breadcrumb-item">Enter Demo Test Details</li>
                                        </ol>
                                    </div>      
                                </div>   
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">Demo Test Form</h3>
                                        </div>
                                        <div class="card-body">
                                            <form role="form" name="demo_test_form" enctype="multipart/form-data" action="<?php echo site_url('support/demo_test_register/save_demo_test');?>" method="post">
