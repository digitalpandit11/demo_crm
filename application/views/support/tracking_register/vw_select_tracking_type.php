...
<html>
	<head>
		<meta charset="utf-8">
	  	...
	  	<title>Select Tracking type</title>
	...
	<body class="hold-transition sidebar-mini">
				                    			...
				                    			<div class="row">
				                      				<div class="col-sm-10">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2bs4" style="width: 100%;" id="tracking_type" name="tracking_type" required>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit" name="confirm_tracking" id="confirm_tracking" class="btn btn-primary">Yes</button>
                    </div>
                </div>
            </div>
        </div>
	    ...
	    <!-- Page script -->
	    <script>
            $(document).on('click', '#confirm_tracking', function () {

                var enquiry_id = document.getElementById('enquiry_id').value;
                var tracking_type = document.getElementById('tracking_type').value;

                if(enquiry_id != "" && tracking_type != "")
                {
                    $.ajax({
                        url:"<?php echo site_url('support/tracking_register/save_tracking');?>",
                        type: 'POST',
                        data: {'enquiry_id' : enquiry_id , 'tracking_type' : tracking_type},
