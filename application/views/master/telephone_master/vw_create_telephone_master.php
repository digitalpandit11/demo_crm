			        	...
			        	<div class="container-fluid">
			          		...
			          		<div class="card">
			            		<div class="card-header" >
			              			<h1 class="card-title">Telephone Register Master</h1>
			              			<div class="col-sm-6">
			                		<br><br>
			                			<ol class="breadcrumb">
			                  				<li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
			                  				<li class="breadcrumb-item"><a href="<?php echo base_url().'vw_telephone'?>">Telephone Register</a></li>
			                  				<li class="breadcrumb-item">Create Telephone Register</li>
			                			</ol>
			              			</div>      
			            		</div>   
			          		</div>        
				          	...
				          	<div class="row">
				            	<div class="col-md-12">
				              		<div class="card card-primary">
				                		<div class="card-header">
				                  			<h3 class="card-title">Telephone Register Details</h3>
				                		</div>
				                		<div class="card-body" style="border-radius: 1.25rem;">
				                  			<form role="form" name="telephone_register_form" id="telephone_register_form" action="<?php echo site_url('master/telephone_master/save_telephone_register');?>" method="post">
				                    			<div class="row">
				                      				<div class="col-sm-6">
