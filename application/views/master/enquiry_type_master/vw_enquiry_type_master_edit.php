				            	...
				            	<div class="col-md-12">
				              		<div class="card card-primary">
				                		...
				                		<div class="card-body" style="border-radius: 1.25rem;">
				                  			<form role="form" name="vendor_type_form" id="vendor_type_form" action="<?php echo site_url('master/enquiry_type_master/edit_enquiry_type');?>" method="post">
				                    			...
				                    			<div class="row">
				                      				<div class="col-sm-6">
				                        				<div class="form-group">
				                          					...
				                          					<input type="text" class="form-control" name="enquiry_type" id="enquiry_type" placeholder="Enter Lead Type" value="<?php echo $enquiry_type;?>" required="required">
				                        				</div>
				                      				</div>      
							                    </div>
