    ...
    <body class="hold-transition sidebar-mini">
                                                                        ...
                                                                        <tbody>
                                                                            <?php
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                    <input type="text" class="form-control" value="<?php echo $row->party_name;?>" id="party_name" name="party_name" style="width: 200px;" onchange="change_party_name(this);">
                                                                                </td>
                                                                                    <td><?php echo $Add_type;?></td>

                                                                                    <td>
                                                                                        <textarea class="form-control" id="address" name="address" style="width: 150px;" rows="3" placeholder="Enter Address" onchange="change_address(this);"><?php echo $row->address;?></textarea>
                                                                                    </td>
                                                                                    <td class="state_id" id="state_id">
                                                                                        <select class="form-control" style="width: 150px;"  id="state_id" name="state_id" onchange="change_state(this);">
                                                                                    ...
                                                                                    <td class="city_id" id="city_id">
                                                                                        <select class="form-control" style="width: 150px;"  id="city_id" name="city_id" onchange="change_city(this);">
                                                                                            <option value="">Not Selected</option>
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="number" class="form-control" value="<?php echo $row->pin_code;?>" id="pin_code" name="pin_code" style="width: 100px;" onchange="change_pincode(this);">
                                                                                    </td>
                                                                                    <td>
                                                                                        <input type="number" class="form-control" value="<?php echo $row->state_code;?>" id="state_code" name="state_code" style="width: 100px;" onchange="change_statecode(this);">
                                                                                    </td>
                                                                                    <td>
                    ...
                    <div class="modal-body">
                        <form role="form" name="customer_contact_details" id="customer_contact_details" method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2bs4" style="width: 100%;" id="state_idss" name="state_idss" required>
                                            <option value="">No Selected</option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2bs4" style="width: 100%;" id="city_idss" name="city_idss" required>
                                            <option></option>
                                        </select>
                                    </div>
                                </div> 
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="state_codess" id="state_codess" class="form-control" size="50" placeholder="State Code" required readonly>
                                    </div>
                                </div>
                            </div> 
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label style="color: #FF0000;"> Pin Code *</label>
                                        <input type="number" name="customer_pin_code" id="customer_pin_code" class="form-control" size="50" placeholder="Enter Customer Pin Code" required>
                                    </div>
                                </div>
        ...
        <script type="text/javascript">
            $(document).on('click', '#add_contact_details', function () {
                ...
                var state_id = $("#state_idss").val();
                var city_id = $("#city_idss").val();
                var customer_pin_code = $("#customer_pin_code").val();
                var customer_state_code = $("#state_codess").val();
                ...
                $.ajax({
                    ...
                    success: function(data){
                        $.each(data, function(i, item){
                            console.log(data);
                            $val = 
                            $('[name="state_codess"]').val(data[i].state_code);
                        })
                    }
                });
                return false;
