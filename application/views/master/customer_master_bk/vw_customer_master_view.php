                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">View Customer</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_customer_master'?>">Customer Master</a></li>
                                            <li class="breadcrumb-item">View Customer Of Id :- <?php  echo $entity_id; ?> </li>
                                        </ol>
                                    </div>      
                                </div>   
                            </div>
                                                                ...
                                                                <div  class="table-responsive">
                                                                   <table id="example1" class="table table-bordered table-striped">
                                                                        ...
                                                                        <tbody>
                                                                            <?php
                                                                                $no = 0;
                                                                                foreach ($customer_address_details as $row):
                                                                                    $no++;
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <textarea class="form-control" id="address" name="address" style="width: 150px;" rows="3" placeholder="Enter Address" disabled onchange="change_address(this);"><?php echo $row->address;?></textarea>
                                                                                    </td>
                                                                                    <td class="state_id" id="state_id">
                                                                                        <select class="form-control" style="width: 150px;"  id="state_id" name="state_id" disabled onchange="change_state(this);">
                                                                                    ...
                                                                                    <td class="city_id" id="city_id">
                                                                                        <select class="form-control" style="width: 150px;"  id="city_id" name="city_id" disabled onchange="change_city(this);">
                                                                                            <option value="">Not Selected</option>
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="number" class="form-control" value="<?php echo $row->pin_code;?>" id="pin_code" name="pin_code" style="width: 100px;" disabled onchange="change_pincode(this);">
                                                                                    </td>
                                                                                    <td>
                                                                                        <input type="number" class="form-control" value="<?php echo $row->state_code;?>" id="state_code" name="state_code" style="width: 100px;" disabled onchange="change_statecode(this);">
                                                                                    </td>
                                                                                    <td>
                                                                                        <input type="text" class="form-control" value="<?php echo $row->gst_no;?>" id="gst_no" name="gst_no" style="width: 200px;" disabled onchange="change_gstnumber(this);">
                                                                                    </td>
                                                                                    <td>
                                                                                        <input type="text" class="form-control" value="<?php echo $row->pan_no;?>" id="pan_no" name="pan_no" style="width: 150px;" disabled onchange="change_pannumber(this);">
                                                                                    </td>
                                                                                    <!-- <td>
                                                                                        <input type="text" class="form-control" value="<?php echo $row->contact_person;?>" id="contact_person" name="contact_person" style="width: 300px;" onchange="change_contactperson(this);">
                                                                                    </td>
                                                                                    <td>
                                                                                        <input type="email" class="form-control" value="<?php echo $row->email_id;?>" id="email_id" name="email_id" style="width: 300px;" onchange="change_emailid(this);">
                                                                                    </td>
                                                                                    <td>
                                                                                        <input type="number" class="form-control" value="<?php echo $row->first_contact_no;?>" id="first_contact_no" name="first_contact_no" style="width: 150px;" onchange="change_contactnumber(this);">      
                                                                                    </td>
                                                                                    <td>
                                                    ...
                                                    <div class="col-md-12">
                                                      <!-- general form elements disabled -->
                                                        <div class="card card-primary">
                                                            ...
                                                            <!-- <div>
                                                                <div class="btn-group" style="margin-top: 15px; margin-left: 20px;">
                                                                    <a data-toggle="modal" data-target="#modal-lg-contact-to" class="btn btn-block btn-primary" style="background-color: #5cb85c; border-color: #4cae4c; color: #ffff;">
                                                                ...
                                                                <div class="table-responsive">
                                                                   <table id="example3" class="table table-bordered table-striped">
                                                                        ...
                                                                        <tbody>
                                                                            <?php
                                                                                $no = 0;
                                                                                foreach ($customer_contact_details as $row):
                                                                                    $no++;
                                                                                    /*$Cust_address_id = $row->Cust_address_id;*/
                                                                                    $Cust_contact_id = $row->Cust_contact_id;
                                                                                    $Address_type = $row->address_type;
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td><?php echo $Add_type;?></td>
                                                                                    <td>
                                                                                        <input type="text" disabled class="form-control" value="<?php echo $row->contact_person;?>" id="contact_person" name="contact_person" style="width: 300px;" onchange="change_contactperson(this);">
                                                                                    </td>
                                                                                    <td>
                                                                                        <input type="email" disabled class="form-control" value="<?php echo $row->email_id;?>" id="email_id" name="email_id" style="width: 300px;" onchange="change_emailid(this);">
                                                                                    </td>
                                                                                    <td>
                                                                                        <input type="number" disabled class="form-control" value="<?php echo $row->first_contact_no;?>" id="first_contact_no" name="first_contact_no" style="width: 150px;" onchange="change_contactnumber(this);">      
                                                                                    </td>
                                                                                    <td>
                                                                                        <input type="number" disabled class="form-control" value="<?php echo $row->second_contact_no;?>" id="second_contact_no" name="second_contact_no" style="width: 150px;" onchange="change_alternatecontactnumber(this);">    
                                                                                    </td>
                                                                                    <td>
                                                                                        <input type="number" disabled class="form-control" value="<?php echo $row->whatsup_no;?>" id="whatsup_no" name="whatsup_no" style="width: 150px;" onchange="change_whatsupcontactnumber(this);">  
                                                                                    </td>
                                                                                </tr>
                                                                            <?php endforeach;?>
                                                                        </tbody>
