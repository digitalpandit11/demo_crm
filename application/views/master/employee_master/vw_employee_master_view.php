                     ...
                     <div class="card-header" >
                        ...
                        <div class="col-sm-6">
                           ...
                           <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item">View Employee Details :- <?php  echo $entity_id; ?></li>
                           </ol>
                        </div>
                     </div>
                  </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                       <div class="form-group">
                                          ...
                                          <input type="text" name="emp_first_name" id="emp_first_name" class="form-control" placeholder="First Name" readonly>
                                       </div>
                                    </div>
                                    <div class="col-sm-3">
                                       <div class="form-group">
                                          <label>Middle Name</label>
                                          <input type="text" name="emp_middle_name" id="emp_middle_name" class="form-control" placeholder="Middle Name" readonly>
                                       </div>
                                    </div>
                                    <div class="col-sm-3">
                                       <div class="form-group">
                                          <label>Last Name</label>
                                          <input type="text" name="emp_last_name" id="emp_last_name" class="form-control" placeholder="Last Name" readonly>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                       <div class="form-group">
                                          ...
                                          <input type="text" name="mobile_no" id="mobile_no" class="form-control" placeholder="Contact No" readonly>
                                       </div>
                                    </div>
                                    <div class="col-sm-3">
                                       <div class="form-group">
                                          <label>Date Of Birth</label>
                                          <input type="date" name="date_of_birth" id="date_of_birth" class="form-control" placeholder="Date Of Birth" readonly>
                                       </div>
                                    </div>
                                    <div class="col-sm-3">
                                       <div class="form-group">
                                          <label>Date Of Joining</label>
                                          <input type="date" name="joining_date" id="joining_date" class="form-control" placeholder="Date Of Joining" readonly>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-sm-4">
                                       <div class="form-group">
                                           ...
                                           <select class="form-control select2bs4" style="width: 100%;" id="emp_region_to_handle" name="emp_region_to_handle" disabled>
                                    ...
                                    <div class="col-sm-3">
                                       <div class="form-group">
                                          ...
                                          <input type="date" name="leaving_date" id="leaving_date" class="form-control" placeholder="Date Of Leaving" readonly>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                       <div class="form-group">
                                          ...
                                          <select class="form-control" style="width: 100%;" id="emp_status" name="emp_status" readonly>
                                              <option value="">No Selected</option>
