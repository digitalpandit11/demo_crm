...
<html>
    <head>
        ...
        <title>Create Product Sub Category</title>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header" >
                                    <h1 class="card-title">Create Product Sub Category</h1>
                                    <div class="col-sm-6">
                                        <br><br>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url().'product_sub_category'?>">Product Sub Category</a></li>
                                            <li class="breadcrumb-item">Enter Product Sub Category Details</li>
                                        </ol>
                                    </div>      
                                </div>   
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">Product Sub Category Master Form</h3>
                                        </div>
                                        <div class="card-body">
                                            <form role="form" name="product_sub_category" action="<?php echo site_url('master/product_sub_category_master/save_product_sub_category_master');?>" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="sub_category_initials" id="sub_category_initials" class="form-control" placeholder="Enter Sub Category Initial's" required>
                                                        </div>
                                                    </div>
                                                </div>
