			        	...
			        	<div class="container-fluid">
			          		...
			          		<div class="card">
			            		<div class="card-header" >
			              			<h1 class="card-title">Edit Make Master</h1>
			              			<div class="col-sm-6">
			                		<br><br>
			                			<ol class="breadcrumb">
			                  				<li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
			                  				<li class="breadcrumb-item"><a href="<?php echo base_url().'vw_material_make_master'?>">Edit Make</a></li>
			                  				<li class="breadcrumb-item">Edit Make :- <?php echo $entity_id; ?></li>
			                			</ol>
			              			</div>      
			            		</div>   
			          		</div>        
				            	...
				            	<div class="col-md-12">
				              		<div class="card card-primary">
				                		...
				                		<div class="card-body" style="border-radius: 1.25rem;">
				                  			<form role="form" name="vendor_type_form" id="vendor_type_form" action="<?php echo site_url('master/material_make_master/edit_material_make');?>" method="post">
