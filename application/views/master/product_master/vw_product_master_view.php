                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="product_id" id="product_id" placeholder="Enter Part Code Number" disabled>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="product_make" id="product_make" class="form-control select2bs4" disabled>
                                                    ...
                                                    <div style="display: none;" class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="product_long_desc" name="product_long_desc" rows="3" placeholder="Enter Product Long Description" disabled></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2bs4" style="width: 100%;" id="product_warranty" name="product_warranty" disabled>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea disabled class="form-control" id="internal_remark" name="internal_remark" rows="3" placeholder="Enter Product Long Description"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2bs4" style="width: 100%;" disabled id="product_status" name="product_status">
                                                                <option value="">No Selected</option>
