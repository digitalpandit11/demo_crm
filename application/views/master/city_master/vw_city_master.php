                    ...
                    <div class="card-header" >
                        ...
                        <div class="col-sm-6">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">Enter City Master Details</li>
                            </ol>
                        </div>      
                    </div>   
                </div>    
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">City Master Info</h3>
                            </div>
                            <div class="card-body" style="border-radius: 1.25rem;">
                                <form state="form" name="client_info" action="<?php echo site_url('master/city_master/save_info');?>" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- text input -->
                                            <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" name="city_name" id="city_name" placeholder="City name" required="required">
                                            </div>
                                      </div>
