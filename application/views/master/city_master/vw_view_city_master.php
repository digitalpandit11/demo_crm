                    ...
                    <div class="card-header" >
                        ...
                        <div class="col-sm-6">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">View City Master Details</li>
                            </ol>
                        </div>      
                    </div>   
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">View City Master Form</h3>
                            </div>
                                    ...
                                    <div class="row" >  
                                       ...
                                       <div class="col-sm-6">
                                          <div class="form-group">
                                              ...
                                              <select class="form-control" style="width: 100%;" id="state_id" name="state_id" required disabled>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                               ...
                                               <input type="text" class="form-control" name="city_name" id="city_name" placeholder="City name" disabled value="<?php echo $city_name;?>" required="required">
                                            </div>
