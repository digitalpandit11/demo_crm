					...
					<div class="card-header">
						...
						<div class="col-sm-6">
							...
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">User Master Form</li>
							</ol>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12">
						...
						<div class="card card-primary">
							...
							<div class="card-body" style="border-radius: 1.25rem;">
								<form role="form" name="client_info" action="<?php echo site_url('master/user_master/save_info'); ?>" method="post">
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-sm-3">
											<div class="form-group">
												...
												<input type="Password" class="form-control" name="password" id="last_name" placeholder="Password" required="required">
											</div>
										</div>
									</div>
									<div class="row">
										...
										<!-- <div class="col-sm-6">
											<div class="form-group">
													...
													<select class="form-control" style="width: 100%;" name="company_id" id="company_id" required>
														<option value="">No Selected</option>
														<?php foreach ($company as $row) : ?>
														<option value="<?php echo $row->entity_id; ?>"><?php echo $row->company_name; ?></option>
														<?php endforeach; ?>
													</select>
											</div>
										</div> -->
