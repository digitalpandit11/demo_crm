					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">View User Info Form</h3>
								</div>
										...
										<div class="row">
											<div class="col-sm-6">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" name="user_name" id="user_name" placeholder="Full Name" required="required" readonly>
												</div>
											</div>
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="Password" class="form-control" name="simple_password" id="simple_password" placeholder="Password" required="required" readonly>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-sm-4">
												...
												<div class="form-group">
													<label>Role</label>
													<select class="form-control" style="width: 100%;" id="role_id" name="role_id" required disabled>
											...
											<!-- <div class="col-sm-4"> -->
												...
												<!-- <div class="form-group">
													...
													<input type="text" class="form-control" name="full_name" id="full_name" placeholder="Full Name" required="required" readonly>
												</div>
											</div>
											<div class="col-sm-4">
												<div class="form-group">
													<label>Mobile No</label>
													<input type="text" class="form-control" name="mobile_no" id="mobile_no" placeholder="Mobile No" required="required" readonly>
												</div>
											</div> -->
										...
										<!-- <div class="row">
											<div class="col-sm-4">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="designation" id="designation" placeholder="Designation" required="required" readonly>
												</div>
											</div>
										</div> -->
										<div class="row">
											<div class="col-sm-4">
												...
												<div class="form-group">
													...
													<select class="form-control" style="width: 100%;" id="activation_status" name="activation_status" required disabled>
