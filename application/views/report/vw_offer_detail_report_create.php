...
<html>
    <head>
        ...
        <title> Offer Detail Report</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Offer Detail Report</h3>
                                    </div>
                                    <div class="card-body" style="border-radius: 1.25rem;">
                                        <form role="form" name="sales_register_report" action="<?php echo site_url('report/report_controller/vw_offer_detail_report_check');?>" method="post">
 ...
 -->
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2bs4" style="width: 100%;" id="offer_no" name="offer_no">
                                                            <option value="">Not Selected</option>

                                                            <?php foreach($offer_result
                                                             as $row):?>
