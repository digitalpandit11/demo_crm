...
<head>
	...
	<title>Lost Order Report <?php //echo date("d-m-Y", strtotime($timesheet_from_date)); ?> To <?php //echo date("d-m-Y", strtotime($timesheet_to_date)); ?></title>
				...
				<div class="container-fluid">
					<div class="card">
						<div class="card-header">
							<h1 class="card-title">Order Lost Report</h1>
							<div class="col-sm-6">
								<br><br>
								<ol class="breadcrumb">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-primary">
								...
								<div class="card-body">
									<form role="form" name="quotation_register_report" action="<?php echo site_url('order_lost_report'); ?>" method="post">
