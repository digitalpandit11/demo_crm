...
<html>
    <head>
        ...
        <title> Warantee Summary Report From <?php echo date("d-m-Y", strtotime($timesheet_from_date));?> To <?php echo date("d-m-Y", strtotime($timesheet_to_date));?></title>
                    ...
                    <div class="container-fluid">
                        <div class="card">
                            <div class="card-header" >
                                <h1 class="card-title">Warantee Summary Report</h1>
                                <div class="col-sm-6">
                                    <br><br>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                        <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_warantee_summary_report'?>">Warantee Summary Report</a>
                                        </li>
                                    </ol>
                                </div>      
                            </div>   
                            ...
                            <div class="col-md-12">
                                <div class="card card-primary">
                                        ...
                                        <div class="container-fluid">
                                            <div class="card">
                                                <div class="card card-success">
                                                    <div class="card-header" >
                                                        <center>
                                                            <h1>Warantee Summary Report From <?php echo date("d-m-Y", strtotime($timesheet_from_date));?> To <?php echo date("d-m-Y", strtotime($timesheet_to_date));?></h1>
                                                        </center>         
                                                    </div> 
                                                </div>  
                                            </div>
                                    ...
                                    <?php
                                        ...
                                        // $where = '(ticket_master.user_id = "'.$user_id.'" And ticket_master.ticket_date >= "'.$timesheet_from_date.'" And ticket_master.ticket_date <= "'.$timesheet_to_date.'"  And ticket_master.ticket_type = 1)';
                                        // $this->db->where($where);
                                                ...
                                                //  print_r($data);
                                                 ...
                                                 ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row->warantee_ticket_count;?></td>
