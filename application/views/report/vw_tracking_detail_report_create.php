...
<html>
    <head>
        ...
        <title> Tracking Detail Report</title>
                            ...
                            <div class="card-header" >
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_tracking_detail_report'?>">Tracking Detail Report</a>
                                        </li>
                                    </ol>
                                </div>      
                            </div>   
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Tracking Detail Report</h3>
                                    </div>
                                    <div class="card-body" style="border-radius: 1.25rem;">
                                        <form role="form" name="sales_register_report" action="<?php echo site_url('report/report_controller/vw_tracking_detail_report_check');?>" method="post">
