...
<head>
	...
	<title>Quotation Register <?php //echo date("d-m-Y", strtotime($timesheet_from_date)); ?> To <?php //echo date("d-m-Y", strtotime($timesheet_to_date)); ?></title>
				...
				<div class="container-fluid">
					<div class="card">
						<div class="card-header">
							<h1 class="card-title">Quotation Regsiter Report</h1>
							<div class="col-sm-6">
								<br><br>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url() . 'dashboard' ?>">Home</a></li>
									<li class="breadcrumb-item"><a href="<?php echo base_url() . 'create_quotation_register' ?>">Create Quotation Register Report</a>
									</li>
								</ol>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-primary">
								...
								<div class="card-body">
									<form role="form" name="quotation_register_report" action="<?php echo site_url('quotation_register_report'); ?>" method="post">
											...
											<div class="col-sm-3">
												<div class="form-group ">
													...
													<?php foreach ($stage_list as $value) {
														...
														<input type="checkbox" class="form-check-input" name="stage[]"  value="<?php echo $value->status_value ?>" > <label class="form-check-label" for=""><?php echo $value->status_name ; ?>
														</label>
														</div>
														<?php } ?>
												</div>
