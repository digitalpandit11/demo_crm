				...
				<div class="container-fluid">
					<div class="card">
						<div class="card-header">
							<h1 class="card-title">Campaign Summary Report</h1>
							<div class="col-sm-6">
								<br><br>
								<ol class="breadcrumb">
						...
						<div class="col-md-12">
							<div class="card card-primary">
								...
								<div class="card-body" style="border-radius: 1.25rem;">
									<form role="form" name="sales_register_report" action="<?php echo site_url('report/report_controller/vw_call_summary_report'); ?>" method="post">

										<div class="row">

												<div class="col-sm-4">
														<div class="form-group">
																<label style="color: #FF0000;">Select Campaign</label>
																<select class="form-control select2bs4" style="width: 100%;" id="campaign" name="campaign" required>
																		<option value="">No Selected</option>
																		<?php foreach ($campaign_list as $row) : ?>
																		<option value="<?php echo $row->entity_id; ?>"><?php echo $row->campaign_name; ?></option>
																		<?php endforeach; ?>
																	</select> 
														</div>
												</div>
