                            ...
                            <div class="card-header" >
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_pending_order_report'?>">Sales Register Report</a>
                                        </li>
                                    </ol>
                                </div>      
                            </div>   
                                            ...
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $no = 0;
                                                        $final_amount = 0;
                                                        foreach ($pending_sales_order_report_date_wise as $row):
                                            ...
                                            <table id="example2" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        foreach ($pending_sales_order_report_of_service_date_wise as $row):
                                                          $entity_id = $row->Entity_id_sales_order;
                                                          $offer_id = $row->offer_id;  
                                                          // print_r($offer_id);
                                                          // die();
                                                          ...
                                                          //$services_final_amount_new = number_format($services_final_amount, 2);
                                                   ...
                                                   <?php $final_amount_with_gst = number_format((float)$services_final_amount, 2, '.', '');?>
                                                   ...
                                                   <tfoot>
                                                        <tr>
                                                            ...
                                                            <td><b>Total :</b></td>
                                                            <td><?php echo $final_amount_with_gst;?></td>
                                                        </tr>
                                                    </tfoot>
                                                </tbody>
                                            </table>
