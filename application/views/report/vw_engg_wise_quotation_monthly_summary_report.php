...
<head>
  ...
  <title>Quotation Monthly Summary Report</title>
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header">
              <h1 class="card-title">Quotation Monthly Summary Report</h1>
              <div class="col-sm-6">
                <br><br>
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<?php echo base_url() . 'dashboard' ?>">Home</a></li>
                  <li class="breadcrumb-item">Quotation Monthly Summary Report
                  </li>
                </ol>
              </div>
            </div>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      // print_r($data);
                        ...
                        foreach($data as $key => $amount_count){
                          ...
                          <tr>
                            <td><?php echo $key;  ?> </td>
                            <td><?php echo (isset($amount_count[0])) ? $amount_count[0]["count"]."<br>(". round($amount_count[0]["amt"]).")" : ""; ?> </td>
                            
                            <td><?php echo (isset($amount_count[1])) ?  $amount_count[1]["count"] ."<br>(".round($amount_count[1]["amt"]).")"  : ""; ?> </td>
                            <td><?php echo (isset($amount_count[2])) ? $amount_count[2]["count"]."<br>(". round($amount_count[2]["amt"]) .")"  : ""; ?> </td>
                            <td><?php echo (isset($amount_count[3])) ? $amount_count[3]["count"]."<br>(". round($amount_count[3]["amt"]).")"  : ""; ?> </td>
                            <td><?php echo (isset($amount_count[4])) ? $amount_count[4]["count"]."<br>(". round($amount_count[4]["amt"]).")"  : ""; ?> </td>
                            <td><?php echo (isset($amount_count[5])) ? $amount_count[5]["count"]."<br>(".round($amount_count[5]["amt"]) .")"  : ""; ?> </td>
                            <td><?php echo (isset($amount_count[6])) ? $amount_count[6]["count"]."<br>(".round($amount_count[6]["amt"]) .")"  : ""; ?> </td>
                            <td><?php echo (isset($amount_count[7])) ? $amount_count[7]["count"]."<br>(". round($amount_count[7]["amt"]).")"  : ""; ?> </td>
                            <td><?php echo (isset($amount_count[8])) ? $amount_count[8]["count"]."<br>(". round($amount_count[8]["amt"]).")"  : ""; ?> </td>
                            <td><?php echo (isset($amount_count[9])) ? $amount_count[9]["count"]."<br>(".round($amount_count[9]["amt"]) .")"  : ""; ?> </td>
                            <td><?php echo (isset($amount_count[10])) ? $amount_count[10]["count"]."<br>(".round($amount_count[10]["amt"]) .")"  : ""; ?> </td>
                            <td><?php echo (isset($amount_count[11])) ? $amount_count[11]["count"]."<br>(". round($amount_count[11]["amt"]).")"  : ""; ?> </td>
