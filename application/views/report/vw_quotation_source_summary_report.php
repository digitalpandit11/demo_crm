...
$first_date_of_current_month = date('Y-m-d',strtotime($current_date.'first day of this month'));

                                        //for 12th month 
                                        $day11 = date('Y-m-d');
                                        $month11 = strtoupper(date('Y-M', strtotime($first_date_of_current_month. "-11 Month")));
                                        ...
                                        //for 11th month 
                                        $day10 = date('');
                                        $month10 = strtoupper(date('Y-M', strtotime($first_date_of_current_month. "-10 Month")));
                                        ...
                                        //for 10th month 
                                        $day9 = date('Y-m-d');
                                        $month9 = strtoupper(date('Y-M', strtotime($first_date_of_current_month. "-9 Month")));
                                        ...
                                        //for 9th month 
                                        $day8 = date('Y-m-d');
                                        $month8 = strtoupper(date('Y-M', strtotime($first_date_of_current_month. "-8 Month")));
                                        ...
                                        //for 8th month 
                                        $day7 = date('Y-m-d');
                                        $month7 = strtoupper(date('Y-M', strtotime($first_date_of_current_month. "-7 Month")));
                                        ...
                                        //for 7th month 
                                        $day6 = date('Y-m-d');
                                        $month6 = strtoupper(date('Y-M', strtotime($first_date_of_current_month. "-6 Month")));
                                        ...
                                        //for 6th month 
                                        $day5 = date('Y-m-d');
                                        $month5 = strtoupper(date('Y-M', strtotime($first_date_of_current_month. "-5 Month")));
                                        ...
                                        //for 5th month 
                                        $day4 = date('');
                                        $month4 = strtoupper(date('Y-M', strtotime($first_date_of_current_month. "-4 Month")));
                                        ...
                                        //for 4th month 
                                        $day3 = date('Y-m-d');
                                        $month3 = strtoupper(date('Y-M', strtotime($first_date_of_current_month. "-3 Month")));
                                        ...
                                        //for 3th month 
                                        $day2 = date('Y-m-d');
                                        $month2 = strtoupper(date('Y-M', strtotime($first_date_of_current_month. "-2 Month")));
                                        ...
                                        //for 2th month 
                                        $day1 = date('Y-m-d');
                                        $month1 = strtoupper(date('Y-M', strtotime($first_date_of_current_month. "-1 Month")));
                                        ...
                                        //for 1th month 
                                        $day0 = date('Y-m-d');
                                        $month0 = strtoupper(date('Y-M', strtotime($first_date_of_current_month. "-0 Month")));
                                        ...
                                        $where = '(offer_all_index.offer_date >= "'.$first_date_of_0month.'" And offer_all_index.offer_date <= "'.$last_date_of_0month.'")';
                                        $this->db->where($where);
                                        ...
                                        $this->db->from('offer_all_index');
                                        $this->db->join('enquiry_source_master', 'enquiry_source_master.entity_id = offer_all_index.offer_source','inner');
                                        $where = '(offer_all_index.offer_date >= "'.$first_date_of_1month.'" And offer_all_index.offer_date <= "'.$last_date_of_1month.'")';
                                        $this->db->where($where);
                                        $this->db->group_by('offer_all_index.offer_source');
                                        $query = $this->db->get();
                                        $query_result = $query->result();
                                        ...
                                        $this->db->from('offer_all_index');
                                        $this->db->join('enquiry_source_master', 'enquiry_source_master.entity_id = offer_all_index.offer_source','inner');
                                        $where = '(offer_all_index.offer_date >= "'.$first_date_of_2month.'" And offer_all_index.offer_date <= "'.$last_date_of_2month.'")';
                                        $this->db->where($where);
                                        $this->db->group_by('offer_all_index.offer_source');
                                        $query = $this->db->get();
                                        $query_result = $query->result();
                                        ...
                                        $this->db->from('offer_all_index');
                                        $this->db->join('enquiry_source_master', 'enquiry_source_master.entity_id = offer_all_index.offer_source','inner');
                                        $where = '(offer_all_index.offer_date >= "'.$first_date_of_3month.'" And offer_all_index.offer_date <= "'.$last_date_of_3month.'")';
                                        $this->db->where($where);
                                        $this->db->group_by('offer_all_index.offer_source');
                                        $query = $this->db->get();
                                        $query_result = $query->result();
                                        ...
                                        $this->db->from('offer_all_index');
                                        $this->db->join('enquiry_source_master', 'enquiry_source_master.entity_id = offer_all_index.offer_source','inner');
                                        $where = '(offer_all_index.offer_date >= "'.$first_date_of_4month.'" And offer_all_index.offer_date <= "'.$last_date_of_4month.'")';
                                        $this->db->where($where);
                                        $this->db->group_by('offer_all_index.offer_source');
                                        $query = $this->db->get();
                                        $query_result = $query->result();
                                        ...
                                        $this->db->from('offer_all_index');
                                        $this->db->join('enquiry_source_master', 'enquiry_source_master.entity_id = offer_all_index.offer_source','inner');
                                        $where = '(offer_all_index.offer_date >= "'.$first_date_of_5month.'" And offer_all_index.offer_date <= "'.$last_date_of_5month.'")';
                                        $this->db->where($where);
                                        $this->db->group_by('offer_all_index.offer_source');
                                        $query = $this->db->get();
                                        $query_result = $query->result();
                                        ...
                                        $this->db->from('offer_all_index');
                                        $this->db->join('enquiry_source_master', 'enquiry_source_master.entity_id = offer_all_index.offer_source','inner');
                                        $where = '(offer_all_index.offer_date >= "'.$first_date_of_6month.'" And offer_all_index.offer_date <= "'.$last_date_of_6month.'")';
                                        $this->db->where($where);
                                        $this->db->group_by('offer_all_index.offer_source');
                                        $query = $this->db->get();
                                        $query_result = $query->result();
                                        ...
                                        $this->db->from('offer_all_index');
                                        $this->db->join('enquiry_source_master', 'enquiry_source_master.entity_id = offer_all_index.offer_source','inner');
                                        $where = '(offer_all_index.offer_date >= "'.$first_date_of_7month.'" And offer_all_index.offer_date <= "'.$last_date_of_7month.'")';
                                        $this->db->where($where);
                                        $this->db->group_by('offer_all_index.offer_source');
                                        $query = $this->db->get();
                                        $query_result = $query->result();
                                        ...
                                        $this->db->from('offer_all_index');
                                        $this->db->join('enquiry_source_master', 'enquiry_source_master.entity_id = offer_all_index.offer_source','inner');
                                        $where = '(offer_all_index.offer_date >= "'.$first_date_of_8month.'" And offer_all_index.offer_date <= "'.$last_date_of_8month.'")';
                                        $this->db->where($where);
                                        $this->db->group_by('offer_all_index.offer_source');
                                        $query = $this->db->get();
                                        $query_result = $query->result();
                                        ...
                                        $this->db->from('offer_all_index');
                                        $this->db->join('enquiry_source_master', 'enquiry_source_master.entity_id = offer_all_index.offer_source','inner');
                                        $where = '(offer_all_index.offer_date >= "'.$first_date_of_9month.'" And offer_all_index.offer_date <= "'.$last_date_of_9month.'")';
                                        $this->db->where($where);
                                        $this->db->group_by('offer_all_index.offer_source');
                                        $query = $this->db->get();
                                        $query_result = $query->result();
                                        ...
                                        $this->db->from('offer_all_index');
                                        $this->db->join('enquiry_source_master', 'enquiry_source_master.entity_id = offer_all_index.offer_source','inner');
                                        $where = '(offer_all_index.offer_date >= "'.$first_date_of_10month.'" And offer_all_index.offer_date <= "'.$last_date_of_10month.'")';
                                        $this->db->where($where);
                                        $this->db->group_by('offer_all_index.offer_source');
                                        $query = $this->db->get();
                                        $query_result = $query->result();
                                        ...
                                        $this->db->from('offer_all_index');
                                        $this->db->join('enquiry_source_master', 'enquiry_source_master.entity_id = offer_all_index.offer_source','inner');
                                        $where = '(offer_all_index.offer_date >= "'.$first_date_of_11month.'" And offer_all_index.offer_date <= "'.$last_date_of_11month.'")';
                                        $this->db->where($where);
                                        $this->db->group_by('offer_all_index.offer_source');
                                        $query = $this->db->get();
                                        $query_result = $query->result();
