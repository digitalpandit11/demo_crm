...
<html>
    <head>
        ...
        <title> Pending Enquiry Detail Report From <?php echo date("d-m-Y", strtotime($timesheet_from_date));?> To <?php echo date("d-m-Y", strtotime($timesheet_to_date));?></title>
                    ...
                    <div class="container-fluid">
                        <div class="card">
                            <div class="card-header" >
                                <h1 class="card-title">Pending Enquiry Detail Report</h1>
                                <div class="col-sm-6">
                                    <br><br>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                        <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_order_detail_report'?>">Pending Enquiry Report</a>
                                        </li>
                                    </ol>
                                </div>      
                            </div>   
                                        ...
                                        <div class="container-fluid">
                                            <div class="card">
                                                <div class="card card-success">
                                                    <div class="card-header" >
                                                        <center>
                                                            <h1>Pending Enquiry Detail Report From <?php echo date("d-m-Y", strtotime($timesheet_from_date));?> To <?php echo date("d-m-Y", strtotime($timesheet_to_date));?></h1>
                                                        </center>         
                                                    </div> 
                                                </div>  
                                            </div>
                                            ...
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $no = 0;
                                                        $final_amount = 0;
                                                        foreach ($pending_enquiry_report_date_wise as $row):
