...
<head>
	...
	<title>Brand Wise Quotation Summary Report</title>
				...
				<div class="container-fluid">
					<div class="card">
						<div class="card-header">
							<h1 class="card-title">Brand Wise Quotation Summary Report</h1>
							<div class="col-sm-6">
								<br><br>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url() . 'dashboard' ?>">Home</a></li>
									<li class="breadcrumb-item"><a href="<?php echo base_url() . 'create_brand_wise_quotation_summary' ?>">Create Brand Wise Quotation Summary Report</a>
									</li>
								</ol>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Brand Wise Quotation Summary<strong>[ <?php echo date("d-m-Y", strtotime($timesheet_from_date))." to ".date("d-m-Y", strtotime($timesheet_to_date)); ?> ]</strong></h3>
								</div>
								...
								<div class="card-body">
									...
									<div class="table-responsive">
										<table id="example1" class="table table-bordered table-striped">
											...
											<tbody>
												...
												$no = 0;
														...
														//get offer value
														$this->db->select('group_concat(offer_product_relation.offer_id,",") as offer_ids,sum(offer_product_relation.total_amount_without_gst) as offer_value,product_make_master.make_name');
														...
														$this->db->join('product_make_master','product_make_master.entity_id = offer_product_relation.product_make','inner');
														$where1 = '(offer_register.offer_date >= "'.$timesheet_from_date.'" and offer_register.offer_date <= "'.$timesheet_to_date.'" )';
														$this->db->where($where1);
														$this->db->group_by('offer_product_relation.product_make', 'DESC');
														$this->db->order_by('product_make_master.make_name', 'ASC');
														$query = $this->db->get();
										...
										$unique_ids = array_filter(array_unique($offer_ids));
										$offer_count = count($unique_ids)-1;
