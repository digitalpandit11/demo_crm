...
<html>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Expense Summary Report</h3>
                                    </div>
                                    <div class="card-body" style="border-radius: 1.25rem;">
                                        <form role="form" name="sales_register_report" action="<?php echo site_url('report/report_controller/vw_expense_summary_report_check');?>" method="post">
 ...
 -->
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2bs4" style="width: 100%;" id="account_head_name" name="account_head_name">
                                                            <option value="">Not Selected</option>

                                                            <?php foreach($account_result
                                                             as $row):?>
                                                            <option value="<?php echo $row->entity_id;?>"><?php echo $row->account_head_name;?></option>
                                                            <?php endforeach;?>
                                                        </select>
                                                    </div>
                                                </div>
