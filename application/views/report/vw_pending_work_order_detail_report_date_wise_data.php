...
<html>
    <head>
        ...
        <title> Pending Work Order Detail Report From</title>
                    ...
                    <div class="container-fluid">
                        <div class="card">
                            <div class="card-header" >
                                <h1 class="card-title">Pending Work Order Detail Report</h1>
                                <div class="col-sm-6">
                                    <br><br>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="<?php echo base_url().'dashboard'?>">Home</a></li>
                                        <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_order_detail_report'?>">Pending Work Order Report</a>
                                        </li>
                                    </ol>
                                </div>      
                            </div>   
                                        ...
                                        <div class="container-fluid">
                                            <div class="card">
                                                <div class="card card-success">
                                                    <div class="card-header" >
                                                        <center>
                                                            <h1>Pending Work Order Detail Report</h1>
                                                        </center>         
                                                    </div> 
                                                </div>  
                                            </div>
                                            ...
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $no = 0;
                                                        $final_amount = 0;
                                                        foreach ($pending_work_order_report_date_wise as $row):
                                                                $no++;
