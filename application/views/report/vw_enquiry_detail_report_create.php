...
<html>
    <head>
        ...
        <title> Enquiry Detail Report</title>
                            ...
                            <div class="card-header" >
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?php echo base_url().'vw_enquiry_detail_report'?>">Enquiry Detail Report</a>
                                        </li>
                                    </ol>
                                </div>      
                            </div>   
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Enquiry Detail Report</h3>
                                    </div>
                                    <div class="card-body" style="border-radius: 1.25rem;">
                                        <form role="form" name="sales_register_report" action="<?php echo site_url('report/report_controller/vw_enquiry_detail_report_check');?>" method="post">
 ...
 -->
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2bs4" style="width: 100%;" id="enquiry_no" name="enquiry_no">
                                                            <option value="">Not Selected</option>

                                                            <?php foreach($enquiry_result
                                                             as $row):?>
                                                            <option value="<?php echo $row->entity_id;?>"><?php echo $row->enquiry_no;?></option>
                                                            <?php endforeach;?>
                                                        </select>
